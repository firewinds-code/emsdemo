	...
	<section class="crousal" style="height: 500px !important;">
		<div class="crosscover" style="background-position: 100% 100%;background-size: 100% 100%;margin-top: 10px;">
			<div class="crosscover-list">
				<?php
				/*  //For Server
				$dirPath =  __DIR__.'/../emp_discount_web/';
				...
				//	echo basename($file);
					...
					if($fileExt == 'png' || $fileExt == 'jpg' || $fileExt == 'jpeg' )
					{
					  ...
					  $dd =  basename($file);
					  echo '<div class="crosscover-item" style="background-size: 100% 100%;background-color: #fff;"><img src="../emp_discount_web/'.$dd.'" alt="image2"/> </div>';  
				...
				if (($resultBy) && $resultBy->num_rows > 0) {
					foreach ($resultBy as $fileRow) {
						echo '<div class="crosscover-item" style="background-size: 100% 100%;background-color: #fff;"><img src="../emp_discount_web/' . $fileRow['file_name'] . '" alt="image2"/> </div>';
					}
				}
