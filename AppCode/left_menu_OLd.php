<script>
	$(function() {
		...
		if ($(".collapsible a[href ='" + loc_left_menu + "']").length > 0) {
			...
			if (loc_left_menu == <?php echo '"' . URL . 'View/"'; ?> || loc_left_menu == <?php echo '"' . URL . 'View/index"'; ?>) {
	...
	<div id="main-menu">
		<div>
			...
			<div id="menu-profile" class="center">
				...
				<a id="user-dropdown" data-gutter="200" data-alignment="left" data-constrainwidth="false" class="dropdown-trigger waves-effect waves-light" href="javascript:;" data-activates="user_menu" data-target='user_menu' ohrm-dropdown="">
					<span id="account-name"><?php echo $__user_Name ?> </span>
					<br>
					<span id="account-job"><?php echo $_user_Desg ?></span><br>
					<span id="account-hold" style="font-size: 10px;"><?php echo $user_Dept . '(' . $user_process . ')'; ?></span>

				</a>

				<ul id="user_menu" class="dropdown-content">
					<li><a href="<?php echo URL . 'View/info?empid=' . $EmployeeID; ?>"><i class="Tiny material-icons">airplay</i>&nbsp;&nbsp;&nbsp;&nbsp;Profile </a></li>
					<li><a href="<?php echo URL . 'View/b_list.php'; ?>"><i class="Tiny material-icons">art_track</i>&nbsp;&nbsp;&nbsp;&nbsp;B'Day List</a></li>
					<li><a href="<?php echo URL . 'View/Logout'; ?>"><i class="Tiny material-icons">block</i>&nbsp;&nbsp;&nbsp;&nbsp;Logout</a></li>
				</ul>

			</div>
			<div id="my-shortcuts">
				<a id="shortcut-menu-trigger" data-gutter="200" data-alignment="left" data-constrainwidth="false" class="dropdown-trigger waves-effect waves-orange" href="javascript:;" data-activates="shortcut_menu" data-target='shortcut_menu'>
				...
				<ul id="shortcut_menu" class="dropdown-content" style="">
					...
					<li><a href="<?php echo URL . 'FileContainer/ISMS Awareness Training.pdf'; ?>" target="_blank">ISMS Awareness</a></li>
				</ul>
			</div>
			<div id="menu-content">
								...
								if (isset($EmployeeID) && $EmployeeID != "") { ?>
									...
									<ul class="collapsible collapsible-accordion">
										...
										<li class="level2">
											...
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/check_session.php?db=dashboard'; ?>" target="_blank">
												<span class="left-menu-title">Delivery Dashboard</span>
												<span class="material-icons collapsible-indicator"></span>
											</a>
										</li>
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/check_session.php?db=dashboard2'; ?>" target="_blank">
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/check_session.php?db=quality'; ?>" target="_blank">
										...
										<?php if ($EmployeeID == 'CEK07120002' || $EmployeeID == 'CE07147134' || $EmployeeID == 'CE03070003' || $EmployeeID == 'CE031929841' || $EmployeeID == 'CE10091236' || $EmployeeID == 'CE0221936010') { ?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/check_session.php?db=panindia'; ?>" target="_blank">
						...
						<li class="level1 Administrator no-padding parent" id="menu_pim_viewPimModule">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									?>
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'lib/dreports'; ?>" id="menu_Attendance_atnd">
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_gatepass.php'; ?>">
									...
									if ($user_type == 'ADMINISTRATOR' && $ut_temp_check == 'ADMINISTRATOR') { ?>
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsDept'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsDesg'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsCli'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/client_subprocess_manage.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/trnE'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/trnP'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/salms'; ?>">
															<span class="material-icons left-menu-icon"></span>
											...
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsAtndUp123'; ?>">
												...
												<span class="material-icons collapsible-indicator"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ithdk_handle_mails.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/wmt'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/module-master'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/master-report'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ReportManager'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ReportData'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsAprMaster'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/Ref_Master'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_ref_register.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsIssue'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/edit-downtime.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/edit-downtime_time_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/edit-buddy_downtime_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/exc_calc.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/salary_slab_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/district_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/edu_board_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/edu_specialization_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/Versant_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/bank_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsAnnounce'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsUpdates'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/alteration.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/AlterationReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/announcement_inproc_master.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_payroll.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_sal_contents.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ipp_handle.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/Login_trnfr.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
									...
									if (($user_type == 'ADMINISTRATOR' && $ut_temp_check == 'ADMINISTRATOR') || ($user_type == 'HR')) { ?>
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/enrolled_employee.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/admin'; ?>">
															<span class="material-icons left-menu-icon"></span>
															<span class="left-menu-title">DashBoard</span>
															<span class="material-icons collapsible-indicator"></span>
														</a>
													...
													<li class="level3 hidden">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/MsInfo'; ?>">
															<span class="material-icons left-menu-icon"></span>
               ...
               <a class="waves-effect waves-orange " href="<?php echo URL . 'View/index.php'; ?>" id="menu_search_empsrch">             <i class="fa fa-lg fa-home"></i>&nbsp;&nbsp;&nbsp;&nbsp;
	               <span class="left-menu-title">Home</span>
					...
					?>
						...
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/empsrch'; ?>" id="menu_search_empsrch">
					...
					?>
						<li class="level1 Attendance no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo "https://demo.cogentlab.com/erpm/Controller/conLog_ems.php?empid=" . $EmployeeID . "&tfs=1&login=admin"; ?>" id="menu_Aadhar_aadh" target="_blank">
									...
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/avr.php'; ?>" id="menu_Aadhar_aadh">
						...
						<li class="level1 Attendance no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ithdk_raise_request_web.php'; ?>" id="ithdk_raise_request_web">
									...
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ithdk_issue_list_and_handling.php'; ?>" id="ithdk_issue_list_and_handling">
					...
					<li class="level1 Attendance no-padding parent">
						...
						<div class="collapsible-body">
							<ul class="collapsible collapsible-accordion">
								<li class="level2">
									<a class="waves-effect waves-orange " href="<?php echo URL . 'View/atnd'; ?>" id="menu_Attendance_atnd">
								...
								?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " id="menu_Attendance_addReq" href="<?php echo URL . 'View/addReq1'; ?>">
										...
										?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " id="menu_Attendance_addReq" href="<?php echo URL . 'View/addReq'; ?>">
					...
					$count_rst = $rst1[0]['count'];*/
								...
								<li class="level2">
									<a class="waves-effect waves-orange " id="menu_DownTime_addDwt" href="<?php echo URL . 'View/addDwt'; ?>">
								...
								?>
									<li class="level2">
										<a class="waves-effect waves-orange " id="menu_DownTime_downtime_bulk" href="<?php echo URL . 'View/downtime_bulk.php'; ?>">
								...
								<li class="level2">
									<a class="waves-effect waves-orange " id="menu_addleave" href="<?php echo URL . 'View/addleave'; ?>">
								...
								<li class="level2">
									<a class="waves-effect waves-orange " id="menu_addleave" href="<?php echo URL . 'View/rpt_co_pl.php'; ?>">
					...
					?>
						<li class="level1 Reports no-padding parent" id="menu_pim_viewPimModule">
							<a class="collapsible-header waves-effect waves-orange active">
								...
								<span class="left-menu-title">Reports <span style="color:red;font-weight: bold;background: transparent;padding: 5px;border-radius: 5px;border: 0px solid #0b7d92;text-shadow: 1px 1px 1px #ffffff, 1px 1px 1px #000000;font-family: sans-serif;" class="animated  flash">New</span></span></span>
								<span class="material-icons collapsible-indicator"></span>
							</a>
								...
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level3">
										...
										?>
												...
												?>
													<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_ncns_spl'; ?>">
														<span class="material-icons left-menu-icon"></span>
					...
					?>
						<li class="level1 ManageEmail no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/manage_email.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/manage_email_module.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/manage_module.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
						...
						<li class="level1 IncentiveManagement no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									?>
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/inc_IncentiveCriteriaApproved.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
									...
									?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/inc_IncentiveCriteriaForAH.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
						...
						<li class="level1 Reports no-padding parent" id="menu_pim_viewPimModule">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2 no-padding parent active">
										...
										<div class="collapsible-body">
											<ul class="collapsible collapsible-accordion">
												...
												<li class="level3">
													<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_at'; ?>">
														<span class="material-icons left-menu-icon"></span>
														<span class="left-menu-title">Attendance</span>
														<span class="material-icons collapsible-indicator"></span>
													</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_interview_map.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<?php if ($EmployeeID == 'CE03070003'  || $EmployeeID == 'CE01145570' || $EmployeeID == 'CE12102224') { ?>
										...
										<li class="level3">
											<a class=" waves-effect waves-orange" href="<?php echo URL . 'View/rpt_health_insurance.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
										...
										<li class="level3">
											<a class=" waves-effect waves-orange" href="<?php echo URL . 'View/rpt_mob_manulal_atnd.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
												<span class="left-menu-title">Manual Atnd Login</span>
											</a>
										</li>
										<li class="level3">
											<a class=" waves-effect waves-orange" href="<?php echo URL . 'View/rpt_manual_atnd.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
									...
									?>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_ab'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_exit'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_erh2h'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_res'; ?>">
															<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/hybrid_report'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rs_rpt'; ?>">
															<span class="material-icons left-menu-icon"></span>
															<span class="left-menu-title">Roster</span>
															<span class="material-icons collapsible-indicator"></span>
														</a>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/cap_report.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rs_apr'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rs_raw_apr'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/cosmoid'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_WeeklyRoster.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_AttendanceTrack.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
											...
											<li class="level2 no-padding parent active">
												...
												<div class="collapsible-body">
													<ul class="collapsible collapsible-accordion">
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/termination'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/releivingexp'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/sentmessageack'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/bdaymsg'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_ncns_sms_status.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_appoint'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<?php if ($EmployeeID == 'CE01145570') { ?>
															<li class="level1 search no-padding parent">
																<a class="waves-effect waves-orange " href="<?php echo URL . 'View/onlineALreport.php'; ?>"> <i class="fa fa-lg fa-certificate "></i>&nbsp;&nbsp;&nbsp;&nbsp;
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/lg_rpt'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rs_pr_rpt'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/mis_Report.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_Perf.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/Tdesh'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														?>
															<li class="level3">
																<a class="waves-effect waves-orange" href="<?php echo URL . 'View/updated-mobilenum-report.php'; ?>">
																	<span class="material-icons left-menu-icon"></span>
														...
														?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_missing.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_doc_status.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/TestReport'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/bgvReport'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/covidAckReport'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rptAdharDigilocker.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
																<span class="left-menu-title">Aadhar updation from digilocker </span>
																<span class="material-icons collapsible-indicator"></span>
															</a>
														</li>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rptCodeOfConductPolicy.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<li class="level2 no-padding parent active">
												...
												<div class="collapsible-body">
													<ul class="collapsible collapsible-accordion">
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_payroll_locked.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_payroll_esic.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_payroll_pf.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<li class="level2 no-padding parent active">
												...
												<div class="collapsible-body">
													<ul class="collapsible collapsible-accordion">
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ClientToClientMoveReport.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ProcessToProcessMoveReport.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/TLtoTLMoveReport.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/QAtoQAMoveReport.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/resign_module_report.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_NCNS_all.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_NCNS_admin.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<li class="level2 no-padding parent active">
												...
												<div class="collapsible-body">
													<ul class="collapsible collapsible-accordion">
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_ECLog.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_TRDaily.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_QRDaily.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_THLog.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/reftohr.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_after.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/offer_latter_download.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
																<span class="left-menu-title">Appointment Letter</span>
																<span class="material-icons collapsible-indicator"></span>
															</a>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_hold_validator.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
									...
									?>
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_Issue.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
												<span class="left-menu-title">Grievance Report</span>
												<span class="material-icons collapsible-indicator"></span>
											</a>
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_dna.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_emp_response.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
									...
									if ($user_type == 'ADMINISTRATOR' || $EmployeeID == 'CE01145570') { ?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_health_ins.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
												<span class="left-menu-title">Health Insurance</span>
												<span class="material-icons collapsible-indicator"></span>
											</a>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_vaccine.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
					...
					?>
						...
						<li class="level1 Reports no-padding parent" id="menu_pim_viewPimModule">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/bgvReport-su'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">BGV Report</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rygReport-su'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/issueReport-su'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">Grievance Report</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
					...
					?>
						<li class="level1 TMS no-padding parent" id="menu_pim_viewPimModule">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									<li class="level2">
										<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_Training_DashBoard.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">Training Dashboard</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
				        ...
				        <?php } ?>-->
									...
									?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/batch_master.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
										...
										?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/th'; ?>" title="List of Employee For Traning Batch Assign Stage">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Training Head<span class="badge"><?php echo $thcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
									...
									?>
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/afterth'; ?>" title="List of Employee For Traning Batch After Training">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">TH to QH Mapping<span class="badge"><?php echo $thcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
										...
										?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/overth'; ?>" title="List of Employee For Traning Batch Incomplete Training">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">TH Overrule<span class="badge"><?php echo $thcount_over; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
									...
									?>
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/tr'; ?>" title="List of Employee For Traning Status">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Trainer<span class="badge"><?php echo $trcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/td'; ?>" title="List of Employee For Traning Status">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Trainer Daily Report<span class="badge"><?php echo $trcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
									...
									?>
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/qh'; ?>" title="List of Employee For Traning Complete Traning and OJT Process">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Quality Head<span class="badge"><?php echo $qhcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/afterqh'; ?>" title="List of Employee For Traning Complete and in OJT Process ">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">QH to OH Mapping<span class="badge"><?php echo $qhcount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
										<?php
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/overqa'; ?>" title="List of Employee For Traning Complete and Decertify in OJT  Process ">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">QA Overrule<span class="badge"><?php echo $qhcount_o; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
						...
						if($rst_count_qh_ops)
						{
							$qh_ops_count = $rst_count_qh_ops[0]['count_qhlist'];
										...
										?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/lqh'; ?>" title="List of Employee Who Complete OJT and Reporting Quality is You ">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">QA Mapping<span class="badge"><?php echo $qh_ops_count; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
										<?php
									...
									?>
										...
										?>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/qa'; ?>" title="List of Employee Who have Complete Traning and In OJT Check List">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Quality Analyst<span class="badge"><?php echo $qacount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/qd'; ?>" title="Add a Report Comment per day for the batch alligned">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Quality Daily Report<span class="badge"><?php echo $qacount; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
									...
									?>
										...
										?>
											...
											<li class="level2">
												<a class="waves-effect waves-orange " href="<?php echo URL . 'View/oh'; ?>" title="List of Employee Who have Complete OJT and Reporting To You">
													<span class="material-icons left-menu-icon"></span>
													<span class="left-menu-title">Operation Head<span class="badge"><?php echo $oh_count; ?></span></span>
													<span class="material-icons collapsible-indicator"></span>
												</a>
											</li>
										<?php
						...
						<li class="level1 Dissemination no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/team_msg.php'; ?>" id="team_msg">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/team_msg_report.php'; ?>" id="team_msg_report">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/team_alert_ActiveUsers.php'; ?>" id="team_alert_ActiveUsers">
											<span class="left-menu-title">Active User</span>
										</a>
									</li>
									<?php if ($status_ah == $EmployeeID && $cm_id == "47") { ?>
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/desimination_matrix.php'; ?>" id="desimination_matrix">
					...
					<li class="level1 QMS no-padding parent">
						...
						<div class="collapsible-body">
							<ul class="collapsible collapsible-accordion">
									...
									<li class="level2 no-padding parent active">
										...
										<div class="collapsible-body">
											<ul class="collapsible collapsible-accordion">
												...
												?>
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/BriefingMaster.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
															<span class="left-menu-title">Briefing</span>
															<span class="material-icons collapsible-indicator"></span>
														</a>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/briefingAcknowledgeReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/BriefingQuizReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/BriefingCoverageReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/QuizResponsesReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
													...
													if ($user_type == 'ADMINISTRATOR' || $user_type == 'CENTRAL MIS') { ?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/BriefingDashboard.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
												...
												?>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/BriefingAgent.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
															<span class="left-menu-title">Briefing</span>
															<span class="material-icons collapsible-indicator"></span>
														</a>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/agentAckReport.php'; ?>">
															<span class="material-icons left-menu-icon"></span>
								...
								<li class="level2">
									<a class="waves-effect waves-orange" href="<?php echo URL . 'View/qmscloud.php'; ?>" target="_blank">
										<span class="material-icons left-menu-icon"></span>
										<span class="left-menu-title">Quality<span style="color:red;font-weight: bold;background: transparent;padding: 5px;border-radius: 5px;border: 0px solid #0b7d92;text-shadow: 1px 1px 1px #ffffff, 1px 1px 1px #000000;font-family: sans-serif;" class="animated  flash">Cloud</span></span>
										<span class="material-icons collapsible-indicator"></span>
									</a>
								</li>
								<!--<li class="level2">
								...
								<li class="level2">
									<a class="waves-effect waves-orange" href="<?php echo URL . 'View/pktcloud.php'; ?>" target="_blank">
										<span class="material-icons left-menu-icon"></span>
										<span class="left-menu-title">PKT<span style="color:red;font-weight: bold;background: transparent;padding: 5px;border-radius: 5px;border: 0px solid #0b7d92;text-shadow: 1px 1px 1px #ffffff, 1px 1px 1px #000000;font-family: sans-serif;" class="animated  flash">Cloud</span></span>
										<span class="material-icons collapsible-indicator"></span>
									</a>
								</li>
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/asset_link.php'; ?>" target="_blank">
								<i class="fa fa-lg fa-tasks "></i>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="left-menu-title">Asset<span style="color:red;font-weight: bold;background: transparent;padding: 5px;border-radius: 5px;border: 0px solid #0b7d92;text-shadow: 1px 1px 1px #ffffff, 1px 1px 1px #000000;font-family: sans-serif;" class="animated  flash">New</span></span>
							</a>
						</li>
					<?php } ?>
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_admin'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_sh'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_acc'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_hr'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/can_rsg_hr'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_req'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_ah'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/can_rsg'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_it'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rsg_oh'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<?php if ($_user_Desg != '' && $_user_Desg != 'CSA' && $_user_Desg != 'Senior CSA') { ?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/TL-2-TL-movement.php?action=tr'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/TL-2-TL-movement.php?action=acc'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/transfer_OH_to_TL.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													if ($_user_Desg != '' && $_user_Desg != 'CSA' && $_user_Desg != 'Senior CSA') { ?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/QA_to_Qa_movement_qac.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/QA_to_Qa_movement_qan.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/QA_to_Qa_movement_qh.php'; ?>">
																<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ncns_acc'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ncns_req'; ?>">
															<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2 no-padding parent active">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ato'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/oto?action=tr'; ?>">
																<span class="material-icons left-menu-icon"></span>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/oto?action=acc'; ?>">
																<span class="material-icons left-menu-icon"></span>
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													...
													if ($status_ah != 'No' && $status_ah == $EmployeeID) { ?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/ah_wt'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														...
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/hr_wt'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													?>
														<li class="level3">
															<a class="waves-effect waves-orange" href="<?php echo URL . 'View/qh_wt'; ?>">
																<span class="material-icons left-menu-icon"></span>
													...
													<li class="level3">
														<a class="waves-effect waves-orange" href="<?php echo URL . 'View/wt_rpt'; ?>">
															<span class="material-icons left-menu-icon"></span>
															<span class="left-menu-title">Report</span>
															<span class="material-icons collapsible-indicator"></span>
														</a>
						...
						<li class="level1 Roster Module no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/roster_module.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_account_roster.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/roster_module_oh.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_oh_roster.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
						...
						<li class="level1 Roster Module no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rosterz_module.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">AH - Roster Template</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_account_rosterz.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">AH - Upload Roster</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rosterz_module_oh.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">OH - Roster Template</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_oh_rosterz.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
											<span class="left-menu-title">OH - Upload Roster</span>
											<span class="material-icons collapsible-indicator"></span>
										</a>
						...
						<li class="level1 MISTask Module no-padding parent">
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/UpRanking.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/up_cosmo_raw'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/upload_team_quality.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
								...
								<a class="waves-effect waves-orange" href="<?php echo URL . 'View/access_card.php'; ?>">
									...
									?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/nestor_Details.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/bqm_details.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
										...
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/buddy_details.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
									...
									?>
										<li class="level2">
											<a class="waves-effect waves-orange" href="<?php echo URL . 'View/security_answer.php'; ?>">
												<span class="material-icons left-menu-icon"></span>
					...
					?>
						...
						?>
							...
							<li class="level1 search no-padding parent">
								<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ChPer'; ?>"> <i class="fa fa-lg fa-bar-chart"></i>&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<ul class="collapsible collapsible-accordion">
									...
									<li class="level2 no-padding parent active">
										...
										<div class="collapsible-body">
											<ul class="collapsible collapsible-accordion">
												<li class="level3">
													<a class="waves-effect waves-orange" href="<?php echo URL . 'View/tm_at'; ?>">
														<span class="material-icons left-menu-icon"></span>
														<span class="left-menu-title">Attendance Report</span>
														<span class="material-icons collapsible-indicator"></span>
													</a>
												...
												<li class="level3">
													<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_Roster_for_rt.php'; ?>">
														<span class="material-icons left-menu-icon"></span>
														<span class="left-menu-title">Roster</span>
														<span class="material-icons collapsible-indicator"></span>
													</a>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_QualityTeam.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_BrifingTeam.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
									...
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/rpt_TeamPerformance.php'; ?>">
											<span class="material-icons left-menu-icon"></span>
			...
			<a class="collapsible-header waves-effect waves-orange">
			   ...
			   <div class="collapsible-body">
			       ...
			       <?php if ($user_type == 'HR') { ?>	               	   
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/offer_latter_report.php'; ?>"> <i class="fa fa-lg fa-book"></i>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="left-menu-title">Appointment Letter</span>
							</a>
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rel_manual'; ?>"> <i class="fa fa-lg fa-book"></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<li class="level1 expenses no-padding parent">
						...
						<div class="collapsible-body">
							<ul class="collapsible collapsible-accordion">
								...
								<li class="level2">
									<a class="waves-effect waves-orange" href="<?php echo URL . 'View/expense'; ?>" id="team_alert_ActiveUsers">
								...
								<?php if ($_SESSION['reviewer'] == "Yes") { ?>
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/expense_review'; ?>" id="team_alert_ActiveUsers">
								...
								<?php if ($_SESSION['approver'] == "Yes") { ?>
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/expense_approv'; ?>" id="team_alert_ActiveUsers">
								...
								<?php if ($_SESSION['reviewer'] == "Yes" || $_SESSION['approver'] == "Yes") { ?>
									<li class="level2">
										<a class="waves-effect waves-orange" href="<?php echo URL . 'View/expense_rpt'; ?>" id="team_alert_ActiveUsers">
											<span class="left-menu-title">Report</span>
										</a>
									</li>
								<?php } ?>
					...
					<?php if ($EmployeeID == 'CE051726660') { ?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/inactive-emp-list.php?flg=0'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					if ($EmployeeID == 'CE03070003' || $EmployeeID == 'CE031929841') { ?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/inactive-emp-list.php?flg=1'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/inactive-remark-report.php'; ?>"> <i class="fa fa-lg fa-cube"></i>&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<div class="collapsible-body">
								<ul class="collapsible collapsible-accordion">
									...
									?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/AppraisalForm.php'; ?>">
									...
									?>
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/AppraisalAH.php'; ?>">
									...
									?>
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/AppraisalApprover.php'; ?>">
										...
										<li class="level2">
											<a class="waves-effect waves-orange " href="<?php echo URL . 'View/AppraisalReport.php'; ?>">
					...
					<li class="level1 search no-padding parent">
						...
						<div class="collapsible-body">
							<ul class="collapsible collapsible-accordion">
								...
								<li class="level2">
									<a class="waves-effect waves-orange " href="<?php echo URL . 'View/CAP_FormEmp'; ?>">
					...
					if (in_array($EmployeeID, $itheldeskuser)) { ?>
						<li class="level1 search no-padding parent">
							...
							<a class=" waves-effect waves-orange" href="<?php echo URL . 'View/ithdk_ticket_report.php'; ?>">
					...
					<li class="level1 search no-padding parent">
						<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ho_list_all.php'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
		  ...
		  <?php } ?>-->
					...
					?>
							<li class="level1 search no-padding parent">
								<a class="waves-effect waves-orange " href="<?php echo URL . 'View/undertaking.php'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						if ($EmployeeID == 'CE0820912495') { ?>
							<li class="level1 search no-padding parent">
								<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_undertaking.php'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
	        ...
	        $icl_idea_check = $myDB->query("select EmployeeID from whole_details_peremp where EmployeeID ='".$_SESSION['__user_logid']."' and clientname like 'Idea';");*/
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ICL - Third Party ISPCC.php'; ?>"> <i class="fa fa-lg fa-certificate"></i>&nbsp;&nbsp;&nbsp;&nbsp;
	        ...
	        $icl_idea_check = $myDB->query("select EmployeeID from whole_details_peremp where EmployeeID ='".$_SESSION['__user_logid']."' and clientname like 'Idea';");*/
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/HSW_Policy.php'; ?>"> <i class="fa fa-lg fa-certificate"></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					?>
										...
										<li class="level1 ChangeSecurity no-padding parent">
											...
											<div class="collapsible-body">
												<ul class="collapsible collapsible-accordion">
													<li class="level1 search no-padding parent">
														<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ALsendOnEmail.php'; ?>">
					...
					?>
						<li class="level1 ChangeSecurity no-padding parent">
							<a class="collapsible-header waves-effect waves-orange" href="<?php echo URL . 'View/upload_bank_esiUan_details.php'; ?>">
								<span class="fa fa-lg fa-tasks">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="left-menu-title">Upload Bank Details</span>
							</a>
						</li>
						<li class="level1 ChangeSecurity no-padding parent">
							<a class="collapsible-header waves-effect waves-orange" href="<?php echo URL . 'View/upload_esicard.php'; ?>">
								<span class="fa fa-lg fa-tasks">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
								<span class="left-menu-title">Upload ESIC Card</span>
							</a>
						</li>
						<li class="level1 ChangeSecurity no-padding parent">
							<a class="collapsible-header waves-effect waves-orange" href="<?php echo URL . 'View/rpt_esic.php'; ?>">
								<span class="fa fa-lg fa-tasks">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					?>
						<li class="level1 ChangeSecurity no-padding parent">
							<a class="collapsible-header waves-effect waves-orange" href="<?php echo URL . 'View/download_esicard.php'; ?>">
								<span class="fa fa-lg fa-tasks">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					?>
						<li class="level1 ChangeSecurity no-padding parent">
							<a class="collapsible-header waves-effect waves-orange" href="<?php echo URL . 'View/print_IDcard.php'; ?>">
								<span class="fa fa-lg fa-tasks">&nbsp;</span>&nbsp;&nbsp;&nbsp;&nbsp;
			...
			?> -->
               ...
               <a class="collapsible-header waves-effect waves-orange">
	               ...
	               <div class="collapsible-body">
					...
					?>
							<li class="level1 search no-padding parent">
								<a class="waves-effect waves-orange " href="<?php echo URL . 'View/ZeroTolerancePolicy.php'; ?>">
									<i class="fa fa-lg fa-certificate "></i>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						?>
							<li class="level1 search no-padding parent">
								<a class="waves-effect waves-orange " href="<?php echo URL . 'View/rpt_ZeroTolerancePolicy.php'; ?>">
									<i class="fa fa-lg fa-certificate "></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<li class="level1 search no-padding parent">
						<a class="waves-effect waves-orange " href="<?php echo URL . 'View/salCert'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'View/sal-detail'; ?>"> <i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<?php if ($EmployeeID == "CE10091236" || $EmployeeID == "CFK08190181" || $EmployeeID == "CE011929747" || $EmployeeID == "CE12102224" || $EmployeeID == "CE01145570" || $EmployeeID == "CE0321936918" || $EmployeeID == "CEV102073966" || $ut_temp_check == 'ADMINISTRATOR') { ?>
						<li class="level1 search no-padding parent">
							<a class="waves-effect waves-orange " href="<?php echo URL . 'QrSetup/qrinfo_videolist.php'; ?>">
								<i class="fa fa-lg fa-list"></i>&nbsp;&nbsp;&nbsp;&nbsp;
