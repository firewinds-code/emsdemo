...
$selectQry = 'select * from expense_miscellaneous where id="' . $_REQUEST['id'] . '"';
$myDB = new MysqliDb();
...
if (count($res) > 0) {
    ...
    $sql = 'delete from expense_miscellaneous where id="' . $_REQUEST['id'] . '"';
    $myDB = new MysqliDb();
...
//             window.location.href = 'expense_miscellaneous.php'; 
//         }, 1000);
//     </script>";
?>
