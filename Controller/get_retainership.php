...
if( count($result) > 0 && $result)	
{
	...
	$designation = $result[0]['des_id'];
	if($designation == '9')
	{
		$designation = 'Customer Support Associate';
	}
	elseif($designation == '12')
	{
		$designation= 'Senior Customer Support Associate';
	} elseif ($designation == '33') {
    echo 'Customer Support Associate - Technical Assistant';
  } elseif ($designation == '34') {
    echo 'Customer Support Associate  - Inside Sales';
  } elseif ($designation == '35') {
    echo 'Customer Support Associate Other1';
  } elseif ($designation == '36') {
    echo 'Customer Support Associate Other2';
  } 
	...
	$address2 = $result[0]['other'];
	$city = $result[0]['city'];
	$state = $result[0]['state'];
	$district = $result[0]['district'];
	$pincode = $result[0]['zip'];
	$reportTo = $result[0]['EmployeeName'];
	$accountHead = $result[0][['EmployeeName'];
?>
...
<p><ol type="a" class="test"><li> Please Note that this is a need  based part time retainership agreement for rendering out –sourced services for  specific duration. You are not an employee of the company and will make no  claim of any other nature normally applicable to employees of the company.</li>
  <li> Indemnity to Company against  personal Injuries etc: Company will not be responsible for any injuries or  accidents met by you during the course of your work at various offices or  during travel to offices or out station travel elsewhere. You will indemnify  the company against any liabilities in this regard.</li></ol></ol>
 <br />
...
<table border="0" cellspacing="0" cellpadding="0" width="100%;">
  <tr>
    <td width="319" valign="top"><p>For   <b><?php 
if('AE' == substr($EmployeeID, 0, 2))
{
?>For Aurum E-Serve LLP </strong><?php }
else
{
