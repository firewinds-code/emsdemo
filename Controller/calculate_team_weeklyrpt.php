 ...
 where ( wh.ReportTo = '".$_REQUEST['empid']."') and wh.EmployeeID != '".$_REQUEST['empid']."' and wh.cm_id ='".$_REQUEST['cm_id']."'";
				...
				{   
					...
					foreach($chk_task as $key => $value)
					{
						...
						{
							$table .='<td style="width: 150px;max-width: 150px;min-width: 150px;padding:0px;"><a onclick="javascript:return calc_Team(this);" data="'.$value['EmployeeID'].'" date="'.$DateTo.'" cm_id="'.$_REQUEST['cm_id'].'" class="btn"><i class="fa fa-plus"></i> '.$value['EmployeeID'].'</a></td>';
						}
						else
						{
