...
if (isset($_REQUEST['id']) && $_REQUEST['id'] != "") {
	...
	$sql = "select EmpName,Address,fathername,designation,createdon from tataaig_decl where EmployeeID='" . $EmpID . "'";
	...
	$pdf2 = "<p>This is to confirm that I <b> " . $Name . " </b> resident of <b>" . $Address . "</b> S/O, D/O <b>" . $Fathername . "</b> am working as <b>" . $desig . "</b> for Tata AIG General Insurance Company Limited.</p><p>I understand and agree to abide confidentiality to be maintained by myself related to my work assigned by Cogent E Services Limited. I hereby declare that I don’t have any criminal records in past. During my tenure with the Company and thereafter also till perpetuity, I agree and confirm that:</p> <p> &nbsp; &nbsp;&nbsp;&nbsp; a) Will ensure no recording or storage device, pen, paper taken on production floor  </p> <p> &nbsp; &nbsp;&nbsp;&nbsp; b) Will ensure no information pertaining to the process is shared to anyone who is not a part of &nbsp; &nbsp;&nbsp;&nbsp;TATA AIG process </p>
	...
	$filename = $EmpID . "_TATAAIG.pdf";
	$path = $target_dir . $filename;


	$tcpdf->SetDefaultMonospacedFont(PDF_FONT_MONOSPACED);

	$tcpdf->SetTitle('Cogent|TATA AIG Decleration Form');
