...
<body>
	<form name="indexForm" enctype="multipart/form-data" role="form" id="indexForm" method="post" action="<?php echo ($_SERVER['PHP_SELF']); ?>">
		...
		$locationid = $Locationresult[0]['location'];
		...
		?>
		 ...
		 220px;height: 100px;" /></div>
						...
						?>
							<div class="col-sm-3 text-left" style="margin: 0px;padding: 0px;width: 220px;position: relative;right: 0px;float: right;"><img src="../Style/images/client_logo.png" style="width:
	 220px;height: 100px;" /></div>
						<?php
						} else {
						?>
	 ...
	 220px;height: 100px;" /></div>
				...
				<p>We are pleased to appoint you in <strong>
						...
						?></strong>(&ldquo;<strong>Company</strong>&rdquo;) as <strong>&lsquo;<?php
																								...
																								?>&rsquo;</strong> at our <strong><?php echo $Locationresult[0]['location']; ?></strong> office as per the employment terms and conditions stated below. Please note that the employment terms contained in this letter (&ldquo;<strong>Appointment Letter</strong>&rdquo;) are subject to Company policy.</p>
				...
				<p><strong>2.         Assignment / transfer</strong>
					Your usual place of work will be at our office at <b><?php echo $Locationresult[0]['location']; ?></b>, India. However, the Company reserves the right to transfer/ assign you to specific projects, assignments, jobs etc. in which case you will be required to perform your services at such location, division, department or branch of the Company as the Company may deem fit.</p>
