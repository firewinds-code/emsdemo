...
if (isset($_REQUEST['id']) && $_REQUEST['id'] != "") {
	...
	$sql = "select EmpName,EmployeeID,Address,fathername,designation,createdon,mobile from hathway_decl where EmployeeID='" . $EmpID . "'";
	...
	$pdf2 = "<p>This is to confirm that I <b> " . $Name . " </b> resident of <b>" . $Address . "</b> S/O, D/O <b>" . $Fathername . "</b> am working as <b>" . $desig . "</b> for Hathway Digital Limited.</p><p>I understand and agree to abide confidentiality to be maintained by myself related to my work assigned by Cogent E Services Limited. I hereby declare that I don’t have any criminal records in past. During my tenure with the Company and thereafter also till perpetuity, I agree and confirm that:</p> <p> &nbsp; &nbsp;&nbsp;&nbsp; a) Will ensure no recording or storage device, pen, paper taken on production floor  </p> <p> &nbsp; &nbsp;&nbsp;&nbsp; b) Will ensure no information pertaining to the process is shared to anyone who is not a part of &nbsp; &nbsp;&nbsp;&nbsp;Hathway Digital Limited process </p>
	...
	<p>I do hereby agree that any non-compliance to the terms as defined under this declaration or any deviation from the Code of Conduct of the Company, then it may lead to disciplinary action against me that may include termination of my employment or criminal prosecution under applicable laws or financial recovery as decided by the Company in future related to my default.</p>
				...
				<p><br /> <b><span>Employee Name: " . $Name . "</span></b><br /> <b><span>Employee ID: " . $EmpID . "</span></b><br /> <b><span>Mobile No: " . $mobile . "</span></b> <br /> <b><span>Date and Time of Action: " . $createdon . "</span></b></p>";

	$tcpdf = new TCPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', true);
	$target_dir = ROOT_PATH . "Hathway/";
	$filename = $EmpID . "_Hathway.pdf";
	$path = $target_dir . $filename;


	$tcpdf->SetDefaultMonospacedFont(PDF_FONT_MONOSPACED);

	$tcpdf->SetTitle('Cogent|Hathway Digital Limited Decleration Form');
	...
	$tcpdf->writeHTMLCell($w = 0, $h = 0, $x = 10, $y = 40, $pdf2, $border = 0, $ln = 0, $fill = false, $reseth = true, $align = '');
	ob_end_clean();
	$tcpdf->Output($path, 'D');
}
