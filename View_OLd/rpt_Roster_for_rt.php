		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (!empty($_POST['monthCount'])) {
					// $monthCount = cleanUserInput($_POST['monthCount']); //seleceted month(01,02....,10,11)
