		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					$chk_task = $myDB->query('call sp_getExceptionReport("' . $userLogID . '","' . $date_From . '","' . $date_To . '","' . $empStatus . '","' . $loca . '")');
...
<script>
	...
	$('#btn_view').on('click', function() {
		...
		var emplevel = <?php echo "'" . clean($_SESSION["__user_type"]) . "'"; ?>;
		if (emplevel == 'ADMINISTRATOR' || emplevel == 'CENTRAL MIS' || emplevel == 'SITEADMIN' || emplevel == 'COMPLIANCE') {
			...
			var dateFrom = parseDMY(date_from) ? date_from : '';
			var dateTo = parseDMY(date_to) ? date_to : '';
			if (dateFrom != '' && dateTo != '') {
				var status = $('#status').val();
				var sp = "call sp_getExceptionReport('" + usrid + "','" + dateFrom + "','" + dateTo + "','" + status + "','" + location + "')";
