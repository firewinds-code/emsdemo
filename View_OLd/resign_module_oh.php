			...
			if ($count_check > 0) {
				...
				foreach ($checked_arr as $val) {
					...
					if ($Status != 'NA' || $Status != 'Na') {
						...
						$sql = 'update resign_details set status_oh = "1" where EmployeeID =?';
						...
						if ($resulti->num_rows > 0) {
							...
							// $sql1 = 'INSERT INTO resign_comment_log(`EmployeeID`,`CreatedBy`,`CreatedOn`,`Comment`,`type`)VALUES("' . $EmpID . '","' . $createBy . '",now(),"' . $Remark . '","OH")';
							$sql1 = 'INSERT INTO resign_comment_log(`EmployeeID`,`CreatedBy`,`CreatedOn`,`Comment`,`type`)VALUES(?,?,now(),?,"OH")';
...
<div id="content" class="content">
	...
	<span id="PageTittle_span" class="hidden">Employee transfer to HR - Resigned [OH] </span>
	...
	<div class="pim-container ">
		...
		<div class="form-div">
			...
			<h4>Employee transfer to HR - Resigned [OH] </h4>
