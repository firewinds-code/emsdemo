	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				$clean_u_logid = clean($_SESSION['__user_logid']);
				$myDB = new MysqliDb();
				$sql = 'call sp_getRoster_pref_Report("' . $clean_u_logid . '","' . $date_From . '","' . $date_To . '")';
				//echo 'call sp_getLogin_Report("'.$clean_u_logid.'","'.$date_From.'","'.$date_To.'")';
				...
				if (empty($mysql_error)) {
					...
					foreach ($chk_task as $key => $value) {
						...
						$table .= '<td>' . date("F", strtotime('00-' . $value['Month'] . '-01')) . '</td>';
