		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<div class="input-field col s6 m6 left-align">
					<?php $empStatus = cleanUserInput($_POST['emp_status']); ?>
					<Select name="emp_status" style="min-width: 200px;" id="status">
						<option value='Summary' <?php if (isset($empStatus) && $empStatus == 'Summary') {
													echo "selected";
												} ?>>Summary Report</option>
						<option value='Detailed' <?php if (isset($empStatus) && $empStatus == 'Detailed') {
														echo "selected";
