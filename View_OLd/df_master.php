...
if (isset($_POST['btn_df_Save'])) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		$txt_df_function = cleanUserInput($_POST['txt_df_function']);
		$_funcid = (isset($txt_df_function) ? $txt_df_function : null);
		$txt_df_desg = cleanUserInput($_POST['txt_df_desg']);
		$_desid = (isset($txt_df_desg) ? $txt_df_desg : null);
...
if (isset($_POST['btn_df_Edit'])) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		$DataID = cleanUserInput($_POST['hid_df_ID']);
		$txt_df_function = cleanUserInput($_POST['txt_df_function']);
		$_funcid = (isset($txt_df_function) ? $txt_df_function : null);
		$txt_df_desg = cleanUserInput($_POST['txt_df_desg']);
		$_desid = (isset($txt_df_desg) ? $txt_df_desg : null);
