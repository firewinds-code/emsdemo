		...
		if ($uploadOk == 0) {
			...
			if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
				...
				foreach ($activeSheetData as $row) {
					$_POST['txt_Type_Upload'] = cleanUserInput($_POST['txt_Type_Upload']);
					if ($row_counter > 0 && !empty($row['A']) && $row['A'] != '') {
						$sql_p_inert = 'CALL insert_rank("' . strtoupper($row['A']) . '","' . $row['B'] . '","' . $clean_type_upload . '","' . $row['C'] . '","' . $row['D'] . '","' . $clean_user_login . '");';
						$myDB = new MysqliDb();
				...
				/*else if($_POST['txt_Type_Upload']=='Attendance')
						{
							foreach ($activeSheetData as $row) {							 	
								...
								{	
						 			...
						 			$sql_p_inert='CALL insert_attendance("'.$row['A'].'","'.$row['B'].'","'.$row['C'].'","'.$row['D'].'","'.$row['E'].'","'.$row['F'].'","'.$row['G'].'","'.$row['H'].'","'.$row['I'].'","'.$row['J'].'","'.$row['K'].'","'.$row['L'].'","'.$row['M'].'","'.$row['N'].'","'.$row['O'].'","'.$row['P'].'","'.$row['Q'].'","'.$row['R'].'","'.$row['S'].'","'.$row['T'].'","'.$row['U'].'","'.$row['V'].'","'.$row['W'].'","'.$row['X'].'","'.$row['Y'].'","'.$row['Z'].'","'.$row['AA'].'","'.$row['AB'].'","'.$row['AC'].'","'.$row['AD'].'","'.$row['AE'].'","'.$row['AF'].'","'.$row['AG'].'","'.$row['AH'].'","'.$row['AI'].'", "'.$clean_user_login.'");';
