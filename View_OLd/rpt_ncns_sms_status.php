...
if (!isset($clean_u_login)) {
	...
	if ($clean_u_login == 'CE10091236' || $clean_u_login == 'CE03070003' || $clean_u_login == 'CE01145570') {
...
$classvarr = "'.byID'";
$icardStatus = '0';
$clean_date_to = cleanUserInput($_POST['txt_dateTo']);
if ($isPostBack && isset($clean_date_to)) {
...
$sql = "select a.EmployeeID, a.EmployeeName, a.DOB, a.DOJ,a.location, concat(a.clientname,' | ',a.Process,' | ',a.sub_process) as newprocess,  a.account_head,a.designation, a.ReportTo , b.sms_text, b.smsstatus,b.EmailAddress,b.emailStatus,b.createdBy, b.createdOn from whole_details_peremp a  inner JOIN  ncns_sms b on a.EmployeeID=b.employeeid where  cast(b.createdOn as date) between ? and ? ";
