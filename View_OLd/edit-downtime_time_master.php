...
if (clean($_SESSION['__user_type']) == 'ADMINISTRATOR' || clean($_SESSION['__user_logid']) == 'CE10091236' || clean($_SESSION['__user_logid']) == 'CE12102224') {
	// proceed further
} else {
	$location = URL . 'Error';
...
if ($btn_df_Save) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		...
		$txt_min_time  = 	cleanUserInput($_POST['txt_min_time']);
		$txt_max_time  = cleanUserInput($_POST['txt_max_time']);
		$txt_total_time  = cleanUserInput($_POST['txt_total_time']);
		$txt_ojt_days  = 	($_POST['txt_ojt_days']);
		$txt_training_days = 	($_POST['txt_training_days']);
		$ojt_day_1 = cleanUserInput($_POST['txt_day_1']);
		$ojt_day_2 = cleanUserInput($_POST['txt_day_2']);
		$ojt_day_3 = cleanUserInput($_POST['txt_day_3']);
		$ojt_day_4 = cleanUserInput($_POST['txt_day_4']);
		$ojt_day_5 = cleanUserInput($_POST['txt_day_5']);
		$ojt_day_6 = cleanUserInput($_POST['txt_day_6']);
		$ojt_day_7 = cleanUserInput($_POST['txt_day_7']);
		$ojt_day_8 = cleanUserInput($_POST['txt_day_8']);
		$ojt_day_9 = cleanUserInput($_POST['txt_day_9']);
		$ojt_day_10 = cleanUserInput($_POST['txt_day_10']);
		$ojt_day_11 = cleanUserInput($_POST['txt_day_11']);
		$ojt_day_12 = cleanUserInput($_POST['txt_day_12']);
		$ojt_day_13 = cleanUserInput($_POST['txt_day_13']);
		$ojt_day_14 = cleanUserInput($_POST['txt_day_14']);
		$ojt_day_15 = cleanUserInput($_POST['txt_day_15']);
		$ojt_day_16 = cleanUserInput($_POST['txt_day_16']);
		$ojt_day_17 = cleanUserInput($_POST['txt_day_17']);
		$ojt_day_18 = cleanUserInput($_POST['txt_day_18']);
		$ojt_day_19 = cleanUserInput($_POST['txt_day_19']);
		$ojt_day_20 = cleanUserInput($_POST['txt_day_20']);

		// $myDB = new MysqliDb();
		$result_checkq = ('SELECT * FROM downtime_time_master where cm_id = ?');

		$stmt = $conn->prepare($result_checkq);
		$stmt->bind_param("i", $_cm_id);
		$stmt->execute();
...
if ($btn_df_Edit) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		...
		if (empty($_POST['txtEditID']) && !is_numeric($_POST['txtEditID'])) {
			...
			$ojt_day_19 = cleanUserInput($_POST['txt_day_19']);
			$ojt_day_20 = cleanUserInput($_POST['txt_day_20']);
			$txtEditID = cleanUserInput($_POST['txtEditID']);
			$Update = 'update downtime_time_master set client_training = ?,client_time_ttl = ?,client_time_min = ?,client_time_max = ?,ojt_days = ?,ojt_day_1 = ?,ojt_day_2 = ?,ojt_day_3 = ?,ojt_day_4 = ?,ojt_day_5 = ?,ojt_day_6 = ?,ojt_day_7 = ?,ojt_day_8 = ?,ojt_day_9 = ?,ojt_day_10 = ?,ojt_day_11 = ?,ojt_day_12 = ?,ojt_day_13 = ?,ojt_day_14 = ?,ojt_day_15 = ?,ojt_day_16 = ?,ojt_day_17 = ?,ojt_day_18 = ?,ojt_day_19 = ?,ojt_day_20 = ?,createdby = ?,training_days=? where cm_id = ? and id = ?;';
			$upstmt = $conn->prepare($Update);
			$upstmt->bind_param("sssssssssssssssssssssssssssii", $txt_client_training, $txt_total_time, $txt_min_time, $txt_max_time, $txt_ojt_days, $ojt_day_1, $ojt_day_2, $ojt_day_3, $ojt_day_4, $ojt_day_5, $ojt_day_6, $ojt_day_7, $ojt_day_8, $ojt_day_9, $ojt_day_10, $ojt_day_11, $ojt_day_12, $ojt_day_13, $ojt_day_14, $ojt_day_15, $ojt_day_16, $ojt_day_17, $ojt_day_18, $ojt_day_19, $ojt_day_20, $createBy, $txt_training_days, $_cm_id, $txtEditID);
