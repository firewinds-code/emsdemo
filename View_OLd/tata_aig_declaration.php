...
if (isset($_POST['btnSave'])) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		$query = "insert into tataaig_decl (EmployeeID, EmpName,Address,fathername,designation) values(?,?,?,?,?) ";
		$stmt = $conn->prepare($query);
		$stmt->bind_param("sssss", $EmployeeID, $EmployeeName, $add, $fathername, $desig);
...
<div id="content" class="content">
	...
	<span id="PageTittle_span" class="hidden">TATA AIG Declaration</span>
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<p style="padding-top: 25px;"> This is to confirm that I <b><?php echo $EmployeeName; ?></b> resident of <b><?php echo $add  ?></b> S/O, D/O <b><?php echo  $fathername  ?></b> am working as <b><?php echo $desig  ?></b> for Tata AIG General Insurance Company Limited. </p>
				...
				<p> &nbsp; &nbsp;&nbsp;&nbsp; b) Will ensure no information pertaining to the process is shared to anyone who is not a part of TATA AIG process </p>
