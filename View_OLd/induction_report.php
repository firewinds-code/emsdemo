            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn'])) {
                    ...
                    foreach ($emp_id as $key => $value) {
                        ...
                        echo  $emp_action = "Update induction_master set EmpFlag=1, HRID=?, HR_modified=now() where EmpID=?";
