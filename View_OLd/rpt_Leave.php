		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					$chk_task = $myDB->query('call sp_getLeaveStatus("' . $usrid . '","' . $date_From . '","' . $date_To . '","' . $empStatus . '","' . $loc . '")');
...
<script>
	$('#btn_view').on('click', function() {
		...
		if (emplevel == 'ADMINISTRATOR' || emplevel == 'CENTRAL MIS' || emplevel == 'SITEADMIN' || emplevel == 'COMPLIANCE') {
			...
			var locationVal = <?php echo "'" . clean($_SESSION["__location"]) . "'"; ?>;
			...
			if (dateFrom != '' && dateTo != '') {
				...
				var sp = "call sp_getLeaveStatus('" + usrid + "','" + dateFrom + "','" + dateTo + "','" + status + "','" + locationVal + "')";
				// alert(sp);
