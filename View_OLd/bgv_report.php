        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['view'])) {
                    ...
                    $sqlConnect = "  select b.id, b.EmployeeID,b.check_flag,b.Modifiedon,c.client_name,w.Process,w.sub_process, w.EmployeeName,w.designation,l1.location,w.DOJ,bv.bgv_vender_name from whole_details_peremp as w join client_master as c on w.client_name=c.client_id join bgv as b on w.EmployeeID=b.EmployeeID join bgv_vender as bv on b.bgv_vender=bv.id join location_master l1 on l1.id=w.location where b.flag=1 and cast(b.Modifiedon as date) between ? and ?";
                    $myDB = new MysqliDb();
                    $conn = $myDB->dbConnect();
