				...
				if (isset($_POST['txt_Type_Upload'])) {
					...
					foreach ($activeSheetData as $row) {
						if ($row_counter > 0 && !empty($row['A']) && $row['A'] != '') {
							...
							$sql_p_inert = 'CALL insert_attendance("' . strtoupper($row['A']) . '","' . $row['B'] . '","' . $row['C'] . '","' . $row['D'] . '","' . $row['E'] . '","' . $row['F'] . '","' . $row['G'] . '","' . $row['H'] . '","' . $row['I'] . '","' . $row['J'] . '","' . $row['K'] . '","' . $row['L'] . '","' . $row['M'] . '","' . $row['N'] . '","' . $row['O'] . '","' . $row['P'] . '","' . $row['Q'] . '","' . $row['R'] . '","' . $row['S'] . '","' . $row['T'] . '","' . $row['U'] . '","' . $row['V'] . '","' . $row['W'] . '","' . $row['X'] . '","' . $row['Y'] . '","' . $row['Z'] . '","' . $row['AA'] . '","' . $row['AB'] . '","' . $row['AC'] . '","' . $row['AD'] . '","' . $row['AE'] . '","' . $row['AF'] . '","' . intval($date_month['month']) . '","' . intval($row['AH']) . '","' . $txt_Type_Upload . '", "' . $user_logid . '");';
