		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if ($userType != 'ADMINISTRATOR' && $userType != 'CENTRAL MIS') {
					$select_briefing = "select a.heading,a.id,a.cm_id,a.CreatedOn,b.sub_process from brf_briefing a INNER JOIN new_client_master b ON a.cm_id=b.cm_id  where a.CreatedBy=? and quiz=? order by a.id desc";
					// $select_briefing .= "  a.CreatedBy='" .$userID  . "' and ";
					$stmt = $conn->prepare($select_briefing);
					$stmt->bind_param('ss', $userID, $quiz);
					$stmt->execute();
				} else {
					$select_briefing = "select a.heading,a.id,a.cm_id,a.CreatedOn,b.sub_process from brf_briefing a INNER JOIN new_client_master b ON a.cm_id=b.cm_id  where quiz=? order by a.id desc";
					$stmt = $conn->prepare($select_briefing);
						...
						<table id="myTable" class="data dataTable no-footer row-border" cellspacing="0" width="100%">
							...
							<tbody>
								...
								if ($bf_id && $bf_id != "") {
									...
									// $select_attempted = "select a.*,b.Answer as ActualAnswer,b.Question,b.Option1,b.Option2,b.Option3,b.Option4,c.EmployeeName from brf_quiz_attempted a INNER JOIN brf_question b ON a.QuestionId=b.QuestionId INNER JOIN personal_details c ON c.EmployeeID=a.EmployeeID where a.BriefingId='" . $bfid . "' order By b.BriefingID,b.QuestionID";
									$select_attempted = "select a.*,b.Answer as ActualAnswer,b.Question,b.Option1,b.Option2,b.Option3,b.Option4,c.EmployeeName from brf_quiz_attempted a INNER JOIN brf_question b ON a.QuestionId=b.QuestionId INNER JOIN personal_details c ON c.EmployeeID=a.EmployeeID where a.BriefingId=? order By b.BriefingID,b.QuestionID";
									$stmt = $conn->prepare($select_briefing);
									$stmt->bind_param('i', $bfid);
									$stmt->execute();
									...
									echo "<script>$(function(){ toastr.info('Quiz Not Found.<code ></code>'); }); </script>";
								}
								?>
							</tbody>
						</table>
