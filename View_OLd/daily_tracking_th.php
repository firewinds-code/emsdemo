...
if ($btn_submit) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		...
		$myDB = new MysqliDb();
		$str  = $myDB->query('call insert_th_log("' . $createBy . '","' . $batch_id . '","' . $txt_body . '")');
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if ($batch_id != 'NA') {
					...
					$sqlConnect = 'call get_tr_dailyreport("' . $userID . '",' . $batch_id . ')';
					$myDB = new MysqliDb();
