...
if (!isset($user_logid)) {
	...
	if ($user_logid == 'CE10091236' || $user_logid == 'CE03070003' || $user_logid == 'CE01145570' || $user_logid == 'CE09134997') {
		$isPostBack = false;
		$referer = "";
		$alert_msg = "";
...
$sql = "select a.EmployeeID, a.EmployeeName, a.DOB, a.DOJ,a.location, concat(a.clientname,' | ',a.Process,' | ',a.sub_process) as newprocess,  a.account_head,a.designation, a.ReportTo , b.email_address, b.status,b.sms_status,b.received_date,b.createdOn from whole_details_peremp a  inner JOIN  esicard b on a.EmployeeID=b.EmployeeID where  cast(b.createdOn as date) between ? and ? ";
?>
