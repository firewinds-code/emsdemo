...
//print_r($_POST);
$rowCount = "";
if (isset($_POST['addSearch']) && cleanUserInput(trim($_POST['remark2'])) != "" && $rstatus == 0) {
	$empid = cleanUserInput(trim($_POST['semployee']));
	$remark = cleanUserInput(trim($_POST['remark2']));
	$rstatus = cleanUserInput(trim($_POST['rstatus']));

	$OH = cleanUserInput(trim($_POST['oh']));
	$AH = cleanUserInput(trim($_POST['account_head']));
	$HR_ID = $user_logid;
...
if (isset($_POST['btnSearch']) && cleanUserInput(trim($_POST['semployee'])) != "") {
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<div id="pnlTable">
					<?php
					if (isset($_POST['btnSearch']) && cleanUserInput(trim($_POST['semployee'])) != "") {
						$empid = cleanUserInput($_POST['semployee']);
