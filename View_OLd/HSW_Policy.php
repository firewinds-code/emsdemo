...
if (isset($_POST['ics_submit'])) {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		...
		$flag = $myDB->insert("hsw_acknowledge", $array_of_values);
		if ($flag) {
...
<div id="content" class="content">
	...
	<span id="PageTittle_span" class="hidden">HSW Policy-Idea</span>
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<embed src="../FileContainer/HSW Induction Vodafone Idea.pdf#view=fit" type="application/pdf" style="height: 400px;overflow-y: auto;width :100%" />
				<?php
				// $default = "select EmployeeID from hsw_acknowledge where EmployeeID='" . $user_logid . "' ";
				$default = "select EmployeeID from hsw_acknowledge where EmployeeID=? ";
