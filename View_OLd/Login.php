...
$clientIPAddress = get_client_ip_ref();
$clientIPAddress1 = filter_var($clientIPAddress, FILTER_VALIDATE_IP);


$android = strpos($_SERVER['HTTP_USER_AGENT'], "Android");
if ($android == true) {
    $location = 'https://demo.cogentlab.com/emsapp/';
...
// $ip_list = $myDB->rawQuery("select distinct IP from whitelistedip where IP = '" . $clientIPAddress1 . "' order by id desc limit 1;");
...
if (isset($_SESSION['__user_logid'])) {
    if (clean($_SESSION['__user_logid']) != '' || clean($_SESSION['__user_logid']) == NULL) {

        $UserName = clean($_SESSION['__user_logid']);
    ...
    if (isset($_SESSION['MsgLg'])) {
        ...
        $msgLogin = '<div id="toast-container" class="toast-top-right" aria-live="polite" role="alert"><div class="toast toast-error" style="display: block;"><button type="button" class="toast-close-button" role="button">×</button><div class="toast-message">' . clean($_SESSION['MsgLg']) . '</div></div></div>';
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 " id="loginFormContainer">
                            ...
                            <div class="col-md-12 paddingTop20" id="midPaneContentWrapper">
                                ...
                                <div class="col-md-6" style="margin-top: 26px;margin-right: 0px !important;padding-right: 13px !important;text-align: right;"><b><a href="<?php echo URL . 'FileContainer/ISMS Awareness Training.pdf'; ?>" target="_blank" style="color: white;">ISMS AWARENESS</a></b></div>
