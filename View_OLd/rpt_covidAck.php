...
if (!isset($userid)) {
	...
	if ($__user_logid == 'CE10091236' || $__user_type == 'ADMINISTRATOR' || $__user_type == 'CENTRAL MIS') {
...
$sql = "select a.id, a.EmployeeID, a.Employeename, a.EmpMobile, a.empAddress, a.createdOn,b.location from ack_covid_weekly_form a  inner join personal_details b on a.EmployeeID=b.EmployeeID where cast(a.createdOn as date) between ? and ? ";
