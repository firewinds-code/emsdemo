...
// echo "ffff" . $ans;
$postIJP = isset($_POST['postIJP']);
if ($postIJP) {
    // echo "<pre>";
    // print_r($_POST);
    $ijpName = cleanUserInput($_POST['ijp_name']);
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if ($btn_search) {
                    ...
                    $where = [];
                    $params = [];
                    $loc = cleanUserInput($_POST['location1']);
                    $tenure = cleanUserInput($_POST['tenure']);
                    $versant = cleanUserInput($_POST['versant']);
                    $education = cleanUserInput($_POST['education']);
                    $abesentism = cleanUserInput($_POST['abesentism']);
                    $client_name1 = cleanUserInput($_POST['client_name1']);
                ?>
                    ...
                    <form method="post" action="">
                        <div id="pnlTable">
                            ...
                            if ($client_name1 == 'ALL') {
                                ...
                                $sqlConnect .= " and t6.client_id='" . $client_name1 . "' ";
                            }
                            $res = '';
                            if ($abesentism != 'NA') {

                                $res = calcAtnd($abesentism, $loc);
