...
echo $sqlstr = "insert into mail_template(empid,name,gender,location,doj,assignment,contact_no,email,designation,immediate_manager,des_id,loc_id,client_name,img) 
