...
?>
<div class="item-container" id="anouncementOnDashboard">
	<div class="inner">
		<ul class="collection" style="width:100%;">
			<?php
			$myDB = new MysqliDb();
			$query = "SELECT Heading, createdon,Body FROM announcement order by createdon,id desc";
					...
					<li class="collection-item avatar">
						<div class="row" style="margin: 0px;">
							...
							<div class="col s12 m12 l12 body-avatar hidden">
								<p style="text-align: justify;"><?php echo $value['Body']; ?></p>
							</div>
						</div>
...
<div class="count-text ">
	...
	<div class="right" style="display: inline;margin-right: 18px;padding-top: 5px;font-size: 13px;">
		<!--Showing: <?php echo count($result); ?> / <?php echo count($result); ?> -->
	</div>
</div>