...
if ($submit && $policy && $_POST['policy'] == 'Yes') {
	if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
		$emp = cleanUserInput($_POST['emp_id']);
		$pass = cleanUserInput($_POST['password']);
		$pass_confirm = cleanUserInput($_POST['password_confirmation']);
		$DOB = cleanUserInput($_POST['dob']);
		$DOJ = cleanUserInput($_POST['doj']);
		$sec = cleanUserInput($_POST['sec_qusn']);
		$sec_asn = cleanUserInput($_POST['sec_asn']);
		$policy = cleanUserInput($_POST['policy']);
		if (($emp == "" || $emp == "NA") || ($pass == "" || $pass == "NA") || ($pass_confirm == "" || $pass_confirm == "NA") || ($DOB == "" || $DOB == "NA") || ($DOJ == "" || $DOJ == "NA") || ($sec == "" || $sec == "NA") || ($sec_asn == "" || $sec_asn == "NA") || $policy == '1') {
					...
					<div class="schema-form-section row">
						...
						<div class="scheduler-border">
							...
							<div class="input-field col s12 m3 l3">
								...
								<label for="policy"><a onclick="openPopup();" title='VIEW CODE OF CONDUCT POLICY'>CODE OF CONDUCT POLICY</a></label>
								<div id='checkval' style="color:red;display:none;">Please Check Code Of Conduct Policy</div>
							</div>
