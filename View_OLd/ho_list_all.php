	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				$data = "SELECT DateOn,Reason as `Holiday List`,Associates,Support FROM ho_list_admin where location=? order by DateOn;";
				$selectQ = $connn->prepare($data);
				$selectQ->bind_param("i", $loc);
				$selectQ->execute();
				$data_ho = $selectQ->get_result();

				if ($data_ho->num_rows > 0) {
