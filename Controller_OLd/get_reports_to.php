...
// $myDB = new MysqliDb();
// $conn = $myDB->dbConnect();
$Client = clean(base64_decode($_REQUEST['client_name1']));
$LOcation = clean(base64_decode($_REQUEST['location1']));
$process1 = clean(base64_decode($_REQUEST['process1']));
$sub_process1 = clean(base64_decode($_REQUEST['sub_process1']));
