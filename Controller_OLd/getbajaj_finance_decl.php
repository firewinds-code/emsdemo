...
if (isset($_REQUEST['id']) && $_REQUEST['id'] != "") {
    ...
    $sql = "select t1.EmployeeID, t1.EmpName,t1.Address,t1.fathername,t1.designation,t1.created_on,t2.Gender from bajaj_finance_decl t1
    ...
    <p>
        ...
        Address :  $address;  and $gender_pre  $fathername  <br>
    ...
    $tcpdf->AddPage();
    $tcpdf->writeHTMLCell($w = 0, $h = 0, $x = 10, $y = 55, $pdf3, $border = 0, $ln = 0, $fill = false, $reseth = true, $align = '');

    $tcpdf->AddPage();
    $tcpdf->writeHTMLCell($w = 0, $h = 0, $x = 10, $y = 55, $pdf4, $border = 0, $ln = 0, $fill = false, $reseth = true, $align = '');
