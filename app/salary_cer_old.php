...
<head>
	...
	<script src="https://ems.cogentlab.com/erpm/Script/jquery.js"></script>
	<script src="https://ems.cogentlab.com/erpm/Script/toastr-master/build/toastr.min.js"></script>

	<link rel="stylesheet" href="https://ems.cogentlab.com/erpm/Script/toastr-master/build/toastr.css" />


	<link rel="icon" type="image/png" href="https://ems.cogentlab.com/erpm/Style/img/favicon.png">
...
<body>
	<div class="container">
		<!-- <div class="row"> -->
		<div class="card card-info" style="margin-top:14rem">
...
<p>This certificate is being issued to him for the purpose of verification only. $company has no liability towards payments against the loan or whatsoever.</p>";
	...
	$reason = $_POST['msg'];
	$myDB = new MysqliDb();
	$Insertdata = "insert into salary_certificate_report (EmployeeID,month, reason,per_email_id,created_at,response)values('" . $employee_id . "','" . $mnth . "','" . $reason . "','" . $emailid . "','" . $dt . "','" . $response . "');";
	$myDB = new MysqliDb();
