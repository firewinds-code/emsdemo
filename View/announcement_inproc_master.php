		    ...
		    <div class="modal-content">
		      ...
		      <div class="modal-body" style="max-height: 100%;float:left;overflow: auto;">
				...
				<?php
					...
					{
						$sqlBy = 'select cm_id,process,sub_process,client_master.client_name from new_client_master inner join client_master on client_master.client_id = new_client_master.client_name where new_client_master.account_head ="'.$_SESSION['__user_logid'].'" ORDER BY process';		
					}
					$myDB=new MysqliDb();
			    ...
			    <?php 
			    if(isset($_POST['btn_clfs_Save']))
			    {
					$cm_id  = $_POST['ddl_clfs_Process'];
					$heading  = $_POST['txt_Announcement_Name'];
					$body  = $_POST['txt_Announcement_Body'];
