	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				$myDB = new MysqliDb();
				$roster_account = $myDB->query("call rosterFor_opshead_between('" . $_SESSION['__user_logid'] . "','" . date('Y-m-d', strtotime($dt_First . ' -7days')) . "','" . date('Y-m-d', strtotime($dt_First . ' -1days')) . "','" . $dept . "')");
				$myDB = new MysqliDb();
				$rst_emp = $myDB->query("call activeFor_opshead('" . $_SESSION['__user_logid'] . "','" . $dept . "')");
				$date_ho_list = array();
				$myDB = new MysqliDb();
