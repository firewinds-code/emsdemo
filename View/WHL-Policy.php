...
{
	$myDB = new MysqliDb();
	$array_of_values = array("EmpID"=>$_SESSION['__user_logid']);
	$flag = $myDB->insert("leave_policy_ack",$array_of_values);
	if($flag)
	{
...
<!-- Header Text for Page and Title -->
	...
	<span id="PageTittle_span" class="hidden">Working Hours and Leave Policy</span>	
...
<!-- Header for Form If any -->
	...
	<?php } ?>	-->
	 ...
	 <h4>Working Hours and Leave Policy</h4>				
...
<!-- Form container if any -->
	...
	<embed src="../FileContainer/Working Hours and Leave Policy.pdf#toolbar=0" style="height: 400px;overflow-y: auto;width :100%"/>
	     <?php 
	$myDB = new MysqliDb();
	$default="select EmpID from leave_policy_ack where EmpID='".$_SESSION['__user_logid']."' ";
