	...
	<div class="schema-form-section row" >
	      <div id="myModal_content" class="modal">
		    ...
		    <div class="modal-content">
		      <h4 class="col s12 m12 model-h4" >Edit District</h4>
					    ...
					    <tbody>					        
					       ...
					       $i=1;
					        foreach($result as $key=>$val){
								...
								<a onclick="editData('<?php echo $ID; ?>','<?php echo $val['state_id']; ?>','<?php echo $val['district']; ?>');" ><i class="material-icons edit_item imgBtn imgBtnEdit tooltipped" data-position="left" data-tooltip="Edit">ohrm_edit</i></a></td>
