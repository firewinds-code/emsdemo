    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                <?php
                if (isset($_POST['btn'])) {
                    $scheduledate = $_POST['schedule_intro'];
                    $schedule = "Update ijp_master set schedule_intro='" . $scheduledate . "' where id='" . $_SESSION['int_id'] . "'";
                    $myDB = new MysqliDb();
