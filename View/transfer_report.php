...
<div class="input-field col s12 m12" id="rpt_container">
	...
	<div class="input-field col s12 m12 right-align">			
        ...
        $sqlConnect = "select t.EmployeeID, l.location,c.client_name, t.process, n.sub_process, t.reports_to from transfer_emp as t join location_master as l on l.id=t.location join client_master as c on c.client_id=t.client_name join new_client_master as n on n.cm_id=t.sub_process  where transfer_date between '" . $date_From . "' and '" . $date_To . "'";
            $myDB = new MysqliDb();
