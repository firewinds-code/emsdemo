		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					//echo 'call sp_get_leave_Report_h2h("' . $_SESSION['__user_logid'] . '","' . $date_From . '","' . $date_To . '")';
					//die;
					$chk_task = $myDB->query('call sp_get_leave_Report_h2h("' . $_SESSION['__user_logid'] . '","' . $date_From . '","' . $date_To . '")');
...
<script>
	$('#btn_view').on('click', function() {
		...
		var sp = "call sp_get_leave_Report_h2h('" + usrid + "','" + date_from + "','" + date_to + "')";
