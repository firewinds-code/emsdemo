...
<div id="content" class="content">
	...
	<span id="PageTittle_span" class="hidden">MIS APR Log Report</span>
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					//echo 'select * from hours_hlp_mis_log where Apr_date between "' . $date_From . '","' . $date_To . '" order by CreatedOn';
					// die;
					$chk_task  =  $myDB->query('select * from hours_hlp_mis_log where Apr_date between "' . $date_From . '" and "' . $date_To . '" order by CreatedOn');
