...
{
	$_Name=(isset($_POST['txt_Updates_Name'])? $_POST['txt_Updates_Name'] : null);
	$_Body=(isset($_POST['txt_Updates_Body'])? $_POST['txt_Updates_Body'] : null);
...
<!-- Header for Form If any -->
	 <h4>Updates Master Details
        ...
        <a class="btn-floating btn-large waves-effect waves-light modal-trigger tooltipped" id="ContentAdd" href="#myModal_content" data-position="bottom" data-tooltip="Add Updates"><i class="material-icons">add</i></a></h4>				
