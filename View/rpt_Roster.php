			...
			<div class="schema-form-section row">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="input-field col s6 m6">
								...
								<Select name="txt_dept" style="min-width: 175px;" id="txt_dept">
									...
									if ($_SESSION['__user_type'] == 'ADMINISTRATOR' || $_SESSION['__user_type'] == 'CENTRAL MIS') {
										...
										$myDB = new MysqliDb1();
										$rowData = $myDB->query('select distinct Process from new_client_master where account_head="' . $_SESSION['__user_logid'] . '" or qh="' . $_SESSION['__user_logid'] . '" or oh="' . $_SESSION['__user_logid'] . '" or th="' . $_SESSION['__user_logid'] . '"');
										if (count($rowData) > 0) {
											foreach ($rowData as $key => $value) {
												if ($dept == $value['Process']) {
													echo '<option selected>' . $value['Process'] . '</option>';
							...
							<div class="input-field col s12 m12 right-align">
								...
								<?php if ($_SESSION['__user_type'] == 'HR' || $_SESSION['__user_type'] == 'ADMINISTRATOR' || $_SESSION['__user_type'] == 'CENTRAL MIS') {  ?>
				...
				if ($monthCount != "") {
					if (($dateLimit < $date_selected)) {
						...
						$chk_task = 'call sp_get_roster_history_Report("' . $_SESSION['__user_logid'] . '","' . $date_To . '","' . $date_From . '","' . $dept . '","' . $EmpStatus . '")';
					}
					//echo $chk_task;
					//die;
					...
					if ($myDB->count > 0) {
				 	...
				 	<div class="input-field col s6 m6">
						...
						echo "<script>$(function(){ toastr.error('No Data Found for applied filter. " . $my_error . "'); }); </script>";
					}
				} else {
