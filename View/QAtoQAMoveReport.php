...
<!--Reprot / Data Table start -->				
		...
		<div id="pnlTable">
			...
			if(isset($_POST['from_date'],$_POST['to_date']) and $_POST['from_date']!="" ){
					 $sqlConnect = "select a.*, d.EmployeeName,d.cm_id,d.DOJ,d.clientname,d.Process,d.sub_process,d.qh ,a.Status, l1.location from tbl_qa_to_qa_movement a INNER JOIN  whole_details_peremp d ON a.EmployeeID=d.EmployeeID join location_master l1 on l1.id = d.location where a.createdon BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']." 23:59:59' ";
					 
					 /*if($_SESSION["__location"]=="1")
					 {
					 	$sqlConnect .= "  (a.createdon BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']." 23:59:59') and d.location in (1,2)";
					 }
					 else
					 {
					 	$sqlConnect .= "  (a.createdon BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']." 23:59:59') and d.location in ('".$_SESSION["__location"]."')";
					 }*/
			...
			if(from_date=="" || to_date==""){
			 ...
			 if(validate==1)
	      	{	   		
	      		...
	      		$(function(){ toastr.error("No Data Found "+alert_msg); });
					return false;
			}
		});
