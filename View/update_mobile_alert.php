...
if (isset($_POST['btnSave'])) {
	...
	$txt_relation = trim($_POST['txt_relation']);
	...
	if ($empid != "" && $mobile != "" && $txt_relation != ""  && $em_contact != "" && $emailid != "") {
		...
		if (empty($mysql_error)) {
			...
			echo "<script>$(function(){ toastr.error('Mobile Number Not Update.'" . $mysql_error . "); }); </script>";
		}
	} else {
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				$myDB = new MysqliDb();
				$select_query = "SELECT mobile,altmobile,em_contact,emailid,em_relation FROM ems.contact_details where EmployeeID='" . $empid . "'";
				$myDB = new MysqliDb();
				...
				<div class="input-field col s12 m12 statuscheck">
					...
					<div class="input-field col s12 m12">
						<div class="input-field col s6 m6 clsIDHome">
							<input type="text" id="mobile" maxlength="10" class="check-numeric" name='mobile' value="<?php echo $mobile; ?>" />
							<label for="mobile">Mobile Number</label>
						</div>

						<div class="input-field col s6 m6 clsIDHome">
							<input type="text" id="altmobile" maxlength="10" class="check-numeric" name="altmobile" value="<?php echo $altmobile; ?>" />
							<label for="altmobile">Alternate Mobile Number</label>
						</div>
					</div>
					<div class="input-field col s12 m12">
						<div class="input-field col s6 m6 clsIDHome">
							<input type="text" id="em_contact" maxlength="10" class="check-numeric" name="em_contact" value="<?php echo $em_contact; ?>">
