		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				?>
					...
					<div class="col s5 m5" style="box-shadow: 0px 5px 10px 0px rgb(0 0 0 / 50%);margin: 8px 8px;height:200px;border-radius: 16px;margin-left:4rem;">
						<div class="row">
				...
				if ($er_spoc2 && $er_spoc2 != "") {
					...
					$img2 .= '"/>';
				?>
					<div class="col s5 m5" style="box-shadow: 0px 5px 10px 0px rgb(0 0 0 / 50%);margin: 8px 8px;height:200px;border-radius: 16px;margin-left:3rem;">
						<div class="row">
