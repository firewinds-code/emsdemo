...
if (isset($_POST['btnSave'])) {
    ...
    if (isset($_POST["token"]) && isset($_SESSION["token"]) && $_POST["token"] == $_SESSION["token"]) {
        $query = "insert into den_decl (EmployeeID, EmpName,Address,fathername,designation,mobile,source) values(?,?,?,?,?,?,?) ";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("sssssis", $EmployeeID, $EmployeeName, $add, $fathername, $desig, $mobile, $source);
...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Den Declaration</span>
    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                <p style="padding-top: 25px;"> This is to confirm that I <b><?php echo $EmployeeName; ?></b> resident of <b><?php echo $add ?></b> S/O, D/O <b><?php echo  $fathername  ?></b> am working as <b><?php echo $desig  ?></b> for Den.</p>
                ...
                <p> &nbsp; &nbsp;&nbsp;&nbsp; b) Will ensure no information pertaining to the process is shared to anyone who is not a part of Den process </p>
                ...
                <p>Employee Name <b><span><?php echo $EmployeeName; ?></b></span> </p>
                <p>Employee ID <b><span><?php echo $EmployeeID; ?></b></span> </p>
                <p>Mobile No <b><span><?php echo $mobile; ?></b></span> </p>
                <p>Date and Time of Action <b><span><?php echo $date; ?></b></span> </p>
