    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = 'select id, sender_empid,sender_name, msg, to_empid,to_empname, created_at, acknowledge, ack_datetime  from  team_msg_ack where sender_empid="' . $_SESSION['__user_logid'] . '"
                    union 
                    select id, sender_empid,sender_name, msg, to_empid,to_empname, created_at, (NOW()), null from team_msg where sender_empid="' . $_SESSION['__user_logid'] . '" ';
                    $myDB = new MysqliDb();
