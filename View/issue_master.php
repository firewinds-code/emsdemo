...
{
	$_Name=(isset($_POST['txt_Issue_Name'])? $_POST['txt_Issue_Name'] : null);
	$_bt=(isset($_POST['txt_Issue_bt'])? $_POST['txt_Issue_bt'] : null);
	$_handler=(isset($_POST['txt_Issue_handler'])? $_POST['txt_Issue_handler'] : null);
	$_tat=(isset($_POST['txt_Issue_tat'])? $_POST['txt_Issue_tat'] : null);	
...
if(isset($_POST['btn_Issue_Edit']))
{	
	$DataID=$_POST['hid_Issue_ID'];
	$_Name=(isset($_POST['txt_Issue_Name'])? $_POST['txt_Issue_Name'] : null);
	$_bt=(isset($_POST['txt_Issue_bt'])? $_POST['txt_Issue_bt'] : null);
	$_handler=(isset($_POST['txt_Issue_handler'])? $_POST['txt_Issue_handler'] : null);
	$_tat=(isset($_POST['txt_Issue_tat'])? $_POST['txt_Issue_tat'] : null);	
