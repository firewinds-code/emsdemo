...
<script>
	$(function(){
		...
		$('#btn_view').click(function(){
			...
			$.ajax({url: "../Controller/OLDownloadIssueALetter.php?EmpID="+txtEmployeeID, success: function(result){
		            if(result == 1)
					{	
	    ...
	    $('#btn_view1').click(function(){
	    	var txtEmployeeID= $('#txtEmployeeID').val();
			$.ajax({url: "../Controller/OLDownloadIssueIdCard.php?EmpID="+txtEmployeeID, success: function(result){
	    ...
	    $('#btn_view2').click(function(){
	    	...
	    	var txtEmployeeID= $('#txtEmployeeID').val();
			$.ajax({url: "../Controller/OLDownloadRetaineship.php?EmpID="+txtEmployeeID, success: function(result){
				//alert(result);
		            if(result)
	    ...
	    $('#btn_handover').click(function(){
	    	...
	    	var txtEmployeeID= $('#txtEmployeeID').val();
			$.ajax({url: "../Controller/OLDownloadHandover.php?EmpID="+txtEmployeeID, success: function(result){
		            if(result)
...
<!-- Form container if any -->
	...
	<div class="input-field col s12 m12 <?php echo $show;?>" id="rpt_container">
		...
		<?php
			$myDB=new MysqliDb();
			$chk_task=$myDB->query('call get_new_emp_forOfferLatter_byHR("'.$_SESSION["__location"].'")');
