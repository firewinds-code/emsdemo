...
if (isset($_POST['btn_contact_Save1']) ) {
	$mob=(isset($_POST['txt_contatc_mob'])? $_POST['txt_contatc_mob'] : null);
	...
	$altmob=(isset($_POST['txt_contatc_altmob'])? $_POST['txt_contatc_altmob'] : null);
	if (strstr($altmob,"X")) {
		$altmob=(isset($_POST['altmobno'])? $_POST['altmobno'] : null);
	}
	$email=(isset($_POST['txt_contatc_email'])? $_POST['txt_contatc_email'] : null);
	$em_contact=(isset($_POST['txt_contatc_em_contact'])? $_POST['txt_contatc_em_contact'] : null);
	$em_relation=(isset($_POST['txt_contatc_em_relation'])? $_POST['txt_contatc_em_relation'] : null);
	$ofcemail=(isset($_POST['txt_contatc_ofcemail'])? $_POST['txt_contatc_ofcemail'] : null);
	$myDB=new MysqliDb();
	$createBy=$_SESSION['__user_logid'];
	...
	$(document).ready(function() {
		$('#btn_contact_Save1').on('click', function(){
			...
			if(txt_contatc_altmob!=""){
	      	...
	      	{		      		
	      		if(alert_msg!=""){
					$(function(){ toastr.info(alert_msg); });
				}
