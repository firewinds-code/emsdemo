...
if ($_SESSION['__user_type'] == 'ADMINISTRATOR' || $_SESSION['__user_type'] == 'CENTRAL MIS') {
	if (isset($_POST['btn_getdata']) && $_POST['txt_empmap_client'] != "") {
		$txt_empmap_client = $_POST['txt_empmap_client'];
	...
	$chk_task = $myDB->query('call EmployeeCycle_reportActiveOPS("' . $_SESSION['__user_logid'] . '")');
}
?>
				...
				?>
					<div class="form-inline col-sm-12" id="rpt_container">
						...
						<div class="input-field col s12 m12 right-align">
							...
							<?php if ($_SESSION['__user_type'] == 'ADMINISTRATOR' || $_SESSION['__user_type'] == 'CENTRAL MIS') {  ?>
