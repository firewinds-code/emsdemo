...
if (isset($_POST['btn_RefMaster_Save'])) {
    ...
    echo $Insert = 'call sp_insert_MasterRefScheme_VH("' . $_cmid . '","' . $_RefAmt . '","' . $_from . '","' . $_to . '","' . $_FPay . '","' . $_SPay . '","' . $_WinMonth . '","' . $emp_type . '","' . $createBy . '")';
...
if (isset($_POST['btn_RefMaster_Edit'])) {
    ...
    echo $Update = 'call sp_Update_MasterRefScheme_VH("' . $DataID . '","' . $_cm_id . '","' . $_RefAmount . '","' . $_from . '","' . $_to . '","' . $_FPay . '","' . $_SPay . '","' . $_WinMonth . '","' . $emp_type . '","' . $ModifiedBy . '")';
    // die;
    $myDB = new MysqliDb();
                            ...
                            <div class="col s12 m12">
                                ...
                                <div class="input-field col s8 m8">
                                    <select id="txt_Client" name="txt_Client" required>
                                        ...
                                        <?php
                                        $sqlBy = "select concat(t3.location,' | ',t2.client_name,' | ',t1.process,' | ',t1.sub_process) as process,cm_id from new_client_master t1 join client_master t2 on t1.client_name=t2.client_id join location_master t3 on t3.id=t1.location where vh='" . $_SESSION['__user_logid'] . "' and cm_id not in (select cm_id from client_status_master) order by t3.location";
                                        $myDB = new MysqliDb();
