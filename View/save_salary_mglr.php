...
$myDB = new  MysqliDb();
$sqlBy = "select des_id,dateofjoin,nc.client_name,nc.cm_id from employee_map inner join df_master on  employee_map.df_id  =  df_master.df_id inner join designation_master on  designation_master.ID  =  df_master.des_id join new_client_master nc on employee_map.cm_id=nc.cm_id where EmployeeID = '" . $EmployeeID . "'";
$myDB = new MysqliDb();
					...
					<div class="input-field col s4 m4">
						<select id="txt_pli_deduct" name="txt_pli_deduct">
							...
							?>
								...
								if (($_SESSION["__user_type"] == 'HR' || $_SESSION["__user_type"] == 'ADMINISTRATOR')) {
