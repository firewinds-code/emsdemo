...
function getPath($val_stype)
{
	...
	if ($_POST['loc'] == "1" || $_POST['loc'] == "2") {
		...
		} else if ($val_stype == 'Education Exception') {
			return $filePath  = ROOT_PATH . "Docs/Edu_exception/";
		} else {
			return $filePath = ROOT_PATH . "Docs/IdentityProof/";
		}
	} else if ($_POST['loc'] == "3") {
	...
	} else if ($_POST['loc'] == "10") {
		$rootloc = "Gurgaon";
		if ($val_stype == 'Proof of Identity') {
			return $filePath = ROOT_PATH . "Gurgaon/Docs/IdentityProof/";
		} else if ($val_stype == 'Proof of Address') {
			return $filePath = ROOT_PATH . "Gurgaon/Docs/AddressProof/";
		} else if ($val_stype == 'FnF') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/FnF/";
		} else if ($val_stype == 'Apology Letter') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/ApologyLetter/";
		} else if ($val_stype == 'Warning Letter') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/WarningLetter/";
		} else if ($val_stype == 'Other') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/Other/";
		} else if ($val_stype == 'BGV Report') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/BGV/";
		} else if ($val_stype == 'Call Log') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/CallLog/";
		} else if ($val_stype == 'Covid 19') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/Covid19/";
		} else if ($val_stype == 'Apprenticeship') {
			return $filePath  = ROOT_PATH . "Gurgaon/Docs/Apprenticeship/";
		} else if ($val_stype == 'Education Exception') {
			return $filePath  = ROOT_PATH . "Docs/Edu_exception/";
		} else {
			return $filePath = ROOT_PATH . "Gurgaon/Docs/IdentityProof/";
		}
	} else if ($_POST['loc'] == "11") {
		$rootloc = "Hyderabad";
		if ($val_stype == 'Proof of Identity') {
			return $filePath = ROOT_PATH . "Hyderabad/Docs/IdentityProof/";
		} else if ($val_stype == 'Proof of Address') {
			return $filePath = ROOT_PATH . "Hyderabad/Docs/AddressProof/";
		} else if ($val_stype == 'FnF') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/FnF/";
		} else if ($val_stype == 'Apology Letter') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/ApologyLetter/";
		} else if ($val_stype == 'Warning Letter') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/WarningLetter/";
		} else if ($val_stype == 'Other') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/Other/";
		} else if ($val_stype == 'BGV Report') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/BGV/";
		} else if ($val_stype == 'Call Log') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/CallLog/";
		} else if ($val_stype == 'Covid 19') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/Covid19/";
		} else if ($val_stype == 'Apprenticeship') {
			return $filePath  = ROOT_PATH . "Hyderabad/Docs/Apprenticeship/";
		} else if ($val_stype == 'Education Exception') {
			return $filePath  = ROOT_PATH . "Docs/Edu_exception/";
		} else {
			return $filePath = ROOT_PATH . "Hyderabad/Docs/IdentityProof/";
...
<div id="content" class="content">
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
							...
							<tr class="trdoc" id="trdoc_1">
								...
								<td>
									<select name="txt_doc_type_1" id="txt_doc_type_1">
										...
										<option value="Education Exception">Education Exception</option>
						...
						<table id="myTable1" class="data dataTable no-footer" cellspacing="0" width="100%">
							...
							<tbody>
								...
								if ($loc == "1" || $loc == "2") {
									...
									$dir_loc = "Gurgaon/Docs";
									$rootloc = 'Gurgaon';
								} else if ($loc == "11") {
									$dir_loc = "Hyderabad/Docs";
									$rootloc = 'Hyderabad';
								}
			...
			<i class="material-icons edit_item imgBtn imgBtnEdit tooltipped" onclick="javascript:return EditDoc(this);"  data-file="' . $value['doc_file'] . '" id="' . $value['doc_id'] . '_' . $value['doc_type'] . '" data-position="left" data-tooltip="Edit">ohrm_edit</i>';
								...
								$sqlConnectisms = "select id from isms_policies_decl where EmployeeID=? order by createdon desc limit 1";
	...
	<i class="material-icons download_item imgBtn imgBtnDownload tooltipped" onclick="javascript:return isms_policies_decl(this);"  data="' . $value['DocID'] . '" 	id="' . $value['doc_type'] . '" id1="' . $value['doc_stype'] . '" data-position="left" data-tooltip="Download File">ohrm_file_download</i>';
								...
								$sqlConnect = "select id from nda_policies_decl where EmployeeID=?";
					...
					$(document).ready(function() {
						...
						function changeevent() {
							$('*[id^=txt_doc_type_]').change(function() {
								...
								} else if ($(this).val() == 'Education Exception') {
									$(this).closest('tr').children("td:nth-child(4)").find('*[id^=txt_doc_stype_]').empty().append('<option>Education Exception</option>');
								}
							});
						}
						changeevent();
		        ...
		        if($("#txt_doc_stype_1").val()=="Adhar Card"){
					...
					function Download(el) {
						...
						if (dirpath == "1" || dirpath == "2") {
							...
							Docs = '/Gurgaon/Docs/';
							Docs_resume = 'Gurgaon/Resume/';
							Docs_chk = 'Gurgaon/checklist_pdf/';
						} else if (dirpath == "11") {
							Docs = '/Hyderabad/Docs/';
							Docs_resume = 'Hyderabad/Resume/';
							Docs_chk = 'Hyderabad/checklist_pdf/';
						}
						...
						if ($(el).attr("id") == "Education Exception") {
							docfile = Docs + "Edu_exception/";
						}
						/*alert(docfile);
						alert($(el).attr("data"));*/
						if ($(el).attr("data") != '') {
