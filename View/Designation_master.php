...
if (isset($_POST['btn_Desg_Save'])) {
	$_Name = (isset($_POST['txt_Desg_Name']) ? $_POST['txt_Desg_Name'] : null);
...
if (isset($_POST['btn_Desg_Edit'])) {
	$DataID = $_POST['hid_Desg_ID'];
	$_Name = (isset($_POST['txt_Desg_Name']) ? $_POST['txt_Desg_Name'] : null);
...
<script>
	...
	function ApplicationDataDelete(el) {
		...
		if (Cnfm) {
			...
			xmlhttp.open("GET", "../Controller/DeleteDesg.php?ID=" + el.id, true);
			xmlhttp.send();
		}
	}
</script>