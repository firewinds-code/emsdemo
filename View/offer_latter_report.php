...
if (isset($_SESSION)) {
	if (!isset($_SESSION['__user_logid'])) {
		...
		if ($_SESSION["__location"] == "1" || $_SESSION["__location"] == "2") {
			...
			} elseif ($_SESSION["__location"] == "7") {

				$dir_location = "Bangalore/";
			} elseif ($_SESSION["__location"] == "8") {

				$dir_location = "Nashik/";
			} elseif ($_SESSION["__location"] == "9") {

				$dir_location = "Anantapur/";
			} elseif ($_SESSION["__location"] == "10") {

				$dir_location = "Gurgaon/";
			} elseif ($_SESSION["__location"] == "11") {

				$dir_location = "Hyderabad/";
			}


			if ($_SESSION['__user_logid'] == "CE05070035" || $_SESSION['__user_logid'] == "CE03070003"  || $_SESSION['__user_logid'] == "CEK061927543" || $_SESSION['__user_logid'] == "CFK09190785" || $_SESSION['__user_logid'] == "CMK06193898") {
				$isPostBack = false;
				$referer = "";
				$alert_msg = "";
				$thisPage = REQUEST_SCHEME . "://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
