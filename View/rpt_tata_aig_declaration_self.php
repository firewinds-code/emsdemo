...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Tata Aig Self Declaration Report</span>
    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <h4> Tata Aig Self Declaration Report </h4>
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn_view'])) {
                    ...
                    <div id="pnlTable">
                        ...
                        $sqlConnect = "select EmployeeID,EmployeeName,designation,location,status,created_on from tataaig_decl_self where cast(created_on as date) between '" . $date_From . "' and '" . $date_To . "'";
