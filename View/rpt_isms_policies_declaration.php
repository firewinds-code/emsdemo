...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">ISMS Policies Acknowledgement Report</span>
    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <h4> ISMS Policies Acknowledgement Report </h4>
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn_view'])) {
                    ...
                    <div id="pnlTable">
                        ...
                        $sqlConnect = "select t1.EmployeeID,t1.EmpName,t4.client_name,t3.process,t3.sub_process,t1.createdon from isms_policies_decl t1 left join employee_map t2 on t1.EmployeeID=t2.EmployeeID
