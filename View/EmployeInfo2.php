	...
	<div id="row" class="row had-container">
	    ...
	    <li>
	      ...
	      <div id="Address_div" class="list-container">
		   ...
		   <!-- <li>
		      <div class="collapsible-header topic"> Salary Details</div>
		      <div class="collapsible-body">
		      <div id="empmap_div" class="list-container">
					<?php 
						if(isset($_REQUEST['empid'])||$EmployeeID!='')
						{
							...
							if(empty($MysqliError)){
								...
								echo '<table class="highlight bordered" cellspacing="0" width="100%">
								<tr>';	
								echo "<td>CTC </td><td><b>Rs.".$value['ctc'];echo '.00</b></td></tr><tr>';
								echo "<td>Take Home </td><td><b>Rs.".$value['net_takehome'];echo '.00</b></td></tr><tr>';
								echo "<td>Provident Fund </td><td><b>Rs.".$value['pf'];echo '.00</b></td></tr><tr>';
								echo "<td>ESIC </td><td><b>Rs.".$value['esis'];echo '.00</b></td></tr><tr>';
