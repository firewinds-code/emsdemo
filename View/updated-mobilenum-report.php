			    ...
			    <div class="form-group"  >
					    <div class="form-inline col-sm-12" id="rpt_container">
							<div class="input-field col s6 m6">
								...
								<input type="text" class="form-control" name="txt_dateFrom"  readonly='true' id="txt_dateFrom" value="<?php if(isset($_POST['txt_dateTo'])) { echo $_POST['txt_dateFrom']; } else { echo date('Y-m-d'); }?>"/>
								<label for="txt_dateFrom">From Date</label>
							</div>
							<div class="input-field col s6 m6">
								<input type="text" class="form-control" name="txt_dateTo" readonly='true' id="txt_dateTo" value="<?php if(isset($_POST['txt_dateTo'])) { echo $_POST['txt_dateTo']; } else { echo date('Y-m-d'); }?>"/>
...
<!--Reprot / Data Table start -->
				...
				$todate=trim($_POST['txt_dateTo']);
				$fromdate=trim($_POST['txt_dateFrom']);
				if($todate!="" && $fromdate!=""){
