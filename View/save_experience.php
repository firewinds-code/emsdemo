...
if (strtoupper($_SERVER['REQUEST_METHOD']) == 'POST') {
	$employer = (isset($_POST['txt_exp_employer']) ? $_POST['txt_exp_employer'] : null);
	$location = (isset($_POST['txt_exp_location']) ? $_POST['txt_exp_location'] : null);
	$from = (isset($_POST['txt_exp_from']) ? $_POST['txt_exp_from'] : null);
	$to = (isset($_POST['txt_exp_to']) ? $_POST['txt_exp_to'] : null);
	$desg = (isset($_POST['txt_exp_desg']) ? $_POST['txt_exp_desg'] : null);
	$disc = (isset($_POST['txt_exp_disc']) ? $_POST['txt_exp_disc'] : null);
	$experience = (isset($_POST['txt_exp_experience']) ? $_POST['txt_exp_experience'] : null);
	$contperson = (isset($_POST['txt_exp_cnp']) ? $_POST['txt_exp_cnp'] : null);
	$contactno = (isset($_POST['txt_exp_cno']) ? $_POST['txt_exp_cno'] : null);
	$ClientIndustry = (isset($_POST['clientindustry']) ? $_POST['clientindustry'] : null);
} else {
	$experience = $contactno = $contperson = $to = $desg = $disc = $employer = $location = $from = $ClientIndustry = '';
}
//Check Employee is exist or not
if (isset($_REQUEST['empid']) && $EmployeeID == '' && !isset($_POST['txt_exp_desg'])) {
...
if (isset($_POST['btn_experice_Add']) && $EmployeeID != '') {
	...
	//$counter_check = 0;
	if ($select_exist_data and count($select_exist_data) > 0) {
...
if (isset($_POST['btn_experice_Save']) && $_POST['expselect'] != '') {
	$myDB = new MysqliDb();

	if ($txt_releiving_experience_doc == '') {
		$txt_releiving_experience_doc = $_POST['fileselect'];
	}
	if ($txt_appointment_offerletter_doc == '') {
		$txt_appointment_offerletter_doc = $_POST['fileselect2'];
	}
	if ($txt_salaryslip_bankstatement_doc == '') {
		$txt_salaryslip_bankstatement_doc = $_POST['fileselect3'];
	}
	...
	if (isset($_POST['expselect']) &&  $experience == "Experienced" && $txt_releiving_experience_doc != "" && $txt_appointment_offerletter_doc != "" && $txt_salaryslip_bankstatement_doc != "") {
		$exp_id = $_POST['expselect'];
	...
	if (isset($_POST['expselect']) && $experience == 'Fresher') {
		$exp_id = $_POST['expselect'];
		$txt_releiving_experience_doc = '';
		$txt_appointment_offerletter_doc = '';
		$txt_salaryslip_bankstatement_doc = '';
