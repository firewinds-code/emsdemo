...
<body>
    ...
    var hybridSelector1 = new hybridSelector(document.getElementById('source1'), document.getElementById('target1'),
        document.getElementById('shift1'), document.getElementById('rshift1'));
