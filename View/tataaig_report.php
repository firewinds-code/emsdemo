...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">TATA AIG Report</span>
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['view'])) {
                    ...
                    $sqlConnect = "select EmployeeID, EmpName,designation,createdon from tataaig_decl where cast(createdon as date) between '" . $date_From . "' and '" . $date_To . "' order by createdon";
                    $myDB = new MysqliDb();
