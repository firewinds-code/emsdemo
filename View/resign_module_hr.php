			...
			$myDB=new MysqliDb();
				...
				foreach($_POST['cb'] as $val)
				{
					...
					if($Status !='NA'||$Status !='Na')
					{
						...
						$sql='update resign_details set status_hr = "1" where EmployeeID = "'.$EmpID.'"';
						...
						if($rowCount>0)
						{
							...
							$myDB=new MysqliDb();
							$sql1 = 'INSERT INTO resign_comment_log(`EmployeeID`,`CreatedBy`,`CreatedOn`,`Comment`,`type`)VALUES("'.$EmpID.'","'.$createBy.'",now(),"'.$Remark.'","HR")';
