			...
			foreach($_POST['check_val_up'] as $checkbox)
			{
				...
				if($result_byID[0]['MgrStatus'] == 'Approve')
				{
					...
					if($Exception=="Working on Holiday" || $Exception=="Working on WeekOff" || $Exception=="Working on Leave" || $Exception=="Roster Change" || $Exception=="Shift Change"   ) 
					{
						if($ShiftIn!="" && $ShiftOut!="" )
						{
							$sqlInsertException = 'call UpdateRequestDetailsManager("'.$ExpID.'","'.$DateFrom.'","'.$DateTo.'","'.$Exception.'","'.$EmployeeComment.'","'.$MngrStatusID.'","'.$HeadStatusID.'","'.$ModifiedBy.'","'.$DateModified.'","'.$IssueType.'","'.$CurrAtt.'","'.$UpdateAtt.'","'.$ShiftIn.'","'.$ShiftOut.'","'.$LeaveType.'","web-addRequest1289")';
						}
						else
						{
						    ...
						    <div class="input-field col s6 m6 8 clsIDHome">
						      ...
						      <select class="" id="txt_Request"  name="txt_Request"  >
                                    ...
                                    <!--<option>Working on Holiday</option>-->
                                     ...
                                     <?php 
					if(($_SESSION["__cm_id"] == "88" || $_SESSION["__cm_id"] == "239" || $_SESSION["__cm_id"] == "265" || $_SESSION["__cm_id"] == "270" || $_SESSION["__cm_id"] == "420" || $_SESSION["__cm_id"] == "444" || $_SESSION["__cm_id"] == "445") && ($_SESSION["__user_Desg"] =='CSA' || $_SESSION["__user_Desg"] =='Senior CSA'))
							{
