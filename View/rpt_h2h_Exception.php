		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					//echo 'call sp_get_exception_Report_h2h("' . $_SESSION['__user_logid'] . '","' . $date_From . '","' . $date_To . '","' . $empStatus . '","' . $_SESSION["__location"] . '")';
					//die;
...
<script>
	...
	$('#btn_view').on('click', function() {
		...
		var sp = "call sp_get_exception_Report_h2h('" + usrid + "','" + date_from + "','" + date_to + "')";
