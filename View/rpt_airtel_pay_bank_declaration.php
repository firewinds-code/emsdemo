...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Airtel Payment Bank Declaration Report</span>
    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <h4> Airtel Payment Bank Declaration Report </h4>
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn_view'])) {
                    ...
                    <div id="pnlTable">
                        ...
                        $sqlConnect = "select EmployeeID,EmpName,address,FatherName,designation,created_on from airtel_pay_bank_decl where cast(created_on as date) between '" . $date_From . "' and '" . $date_To . "'";
