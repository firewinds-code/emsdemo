...
if (isset($_SESSION)) {
	...
	if ($_SESSION['__user_type'] == 'ADMINISTRATOR' || $_SESSION['__user_type'] == 'HR' || $_SESSION['__user_type'] == 'CENTRAL MIS' || $_SESSION['__user_logid'] == 'CE10091236' || $_SESSION['__user_logid'] == 'CE12102224') {
		// proceed further
	} else {
		$location = URL;
            ...
            <div class="schema-form-section row">
                ...
                <div id="pnlTable">
					...
					if (isset($_POST['btn_view'])) {
						...
						$myDB = new MysqliDb();
						$query_Select = "select r.RefID,r.createdon,r.CandidateName, r.CandidateNumber,r.EmployeeID ,concat(r.client,'-',r.Process,'-',r.SubProcess) as Process,r.EmployeeName from tbl_reference_reg_detail r  where cast(r.createdon as date) between '" . $date_From . "' and '" . $date_To . "' order by createdon";
						...
						if (count($result) > 0) {
							...
							<th>Walkin(Y/N)</th>
							<th>Walkin Date</th>
							<th>Interview Cleared(Y/N)</th
							><th>Process Selected</th>
							<th>Joining Date</th>
							<th>Joined Y/N</th>
							<th>Candidate EmployeeID</th>
							<th>Salary CTC</th>
