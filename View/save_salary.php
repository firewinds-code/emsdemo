...
$alert_msg = $EmployeeID = $btnShow = $emptype = $paytype = $newctc = $pfaccount = $esiNo = $file_esi = $MinWages = $basic = $hra = $convence = $sp_allow = $gorss_sal = $pf_count = $pf_empl_count = $esis_count = $esis_empl_count = $professional_tex = $takehome = $pli = $pli_percent = $pli_ammount = $nt_takehome = $pli_status = $pf_status = $pli_mode = $uino = $pli_effected = $pli = $bonus = $gratuity = $medical_allowance = $sal_type = '';
$professional_tex = 0;
$rt_type = 1;
					...
					<div class="input-field col s4 m4">
						<select id="txt_pli_deduct" name="txt_pli_deduct">
							...
							?>
								...
								if ($des_id != 9 && $des_id != 12 && $des_id != 30 && $des_id != 33 && $des_id != 34) {
								?>
								...
								?>
								<option>No</option>
								<?php if ($des_id != 9 && $des_id != 12 && $des_id != 30 && $des_id != 33 && $des_id != 34) { ?>
