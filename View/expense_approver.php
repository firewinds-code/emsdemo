...
// echo $sqlFood = 'SELECT * FROM expense_food';
// $myDB = new MysqliDb();
// $result1 = $myDB->rawQuery($sqlFood);
// echo $foodStatus = $result1[0]['reviewerStatus'];
// echo $_POST['hid_expense_foodID'];
...
// $sqlmobile = 'SELECT * FROM expense_mobile';
// $myDB = new MysqliDb();
// $result5 = $myDB->rawQuery($sqlmobile);
// $mobileStatus = $result5[0]['reviewerStatus'];
...
if ($btn_edit_expenseMobile) //for travel submit
{
    if (isset($_POST["token4"]) && isset($_SESSION["token4"]) && $_POST["token4"] == $_SESSION["token4"]) {
        ...
        $mgrStatus = cleanUserInput($_POST['mobile_mgrStatus']);
        $mgrComment = cleanUserInput($_POST['mobile_mgrComment']);
        $update_mobile = 'UPDATE expense_mobile SET mgrStatus=?,mgrComment=?,approverStatus="Approved",modified_at=now() WHERE id=?';
        $stmt = $conn->prepare($update_mobile);
        $stmt->bind_param("ssi", $mgrStatus, $mgrComment, $mobileID);
        $stmt->execute();
        $stmtRes = $stmt->get_result();
        if ($stmt->affected_rows === 1) {
            echo "<script>$(function(){toastr.success('Record Updated Successfully'); }); </script>";
    ...
    <div class="pim-container">
        ...
        <div class="form-div" id="divfood">
            ...
            <div class="schema-form-section row">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                ...
                                <div class="input-field col s4 m4">
                                    <input type="text" name="reviewerStatus" id="reviewerStatus" disabled>
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = "SELECT t1.* FROM expense_food t1 join EmpID_Name t2 on t1.EmployeeID=t2.empid join expense_matrix t3 on t2.loc=t3.location where t3.EmployeeID='" . $_SESSION['__user_logid'] . "' and t3.is_approver='Yes' and reviewerStatus='Approve' and mgrStatus ='Pending' ";
                    $myDB = new MysqliDb();
        ...
        <div class="form-div" id="divTravel">
            ...
            <div class="schema-form-section row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post">
                                ...
                                <!-- <div class="input-field col s4 m4 l4" id="divtravelImg">
                                  <input type="text" name="receipt_image" id="travel_receipt_image" readonly> -->
                                <!-- <span>Receipt Image</span><br>
                                    <a href="../ExpenseTravel/<?php echo $result2[0]['receipt_image']; ?>" target="_blank" download><?php echo $result2[0]['receipt_image']; ?></a> -->
                                <!-- </div> -->
                                ...
                                <div class="input-field col s4 m4">
                                    <input type="text" id="travel_reviewerStatus" name="reviewerStatus" disabled>
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = "SELECT t1.* FROM expense_travel t1 join EmpID_Name t2 on t1.EmployeeID=t2.empid join expense_matrix t3 on t2.loc=t3.location where t3.EmployeeID='" . $_SESSION['__user_logid'] . "' and is_approver='Yes' and reviewerStatus='Approve' and mgrStatus ='Pending' ";
                    $myDB = new MysqliDb();
                    $result = $myDB->rawQuery($sqlConnect);
                    $mysql_error = $myDB->getLastError();
                    if (empty($mysql_error)) {
        ...
        <div class="form-div" id="divHotel">
            ...
            <div class="schema-form-section row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                ...
                                <div class="input-field col s4 m4">
                                    <input type="text" id="hotel_reviewerStatus" name="reviewerStatus" disabled>
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = "SELECT t1.*,t4.location as visited_location FROM expense_hotel t1 join EmpID_Name t2 on t1.EmployeeID=t2.empid join expense_matrix t3 on t2.loc=t3.location left join location_master t4 on t1.location=t4.id where t3.EmployeeID='" . $_SESSION['__user_logid'] . "' and is_approver='Yes' and reviewerStatus='Approve' and mgrStatus ='Pending'";
        ...
        <div class="form-div" id="divMiscellaneous">
            ...
            <div class="schema-form-section row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                ...
                                <div class="input-field col s4 m4">
                                    <input type="text" id="miscellaneous_reviewerStatus" name="reviewerStatus" disabled>
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = 'SELECT t1.* FROM ems.expense_miscellaneous t1 join EmpID_Name t2 on t1.EmployeeID=t2.empid join expense_matrix t3 on t2.loc=t3.location where t3.EmployeeID="' . $_SESSION['__user_logid'] . '" and is_approver="Yes"';
                    $myDB = new MysqliDb();
                    $result = $myDB->rawQuery($sqlConnect);
                    $mysql_error = $myDB->getLastError();
                    if (empty($mysql_error)) { ?>
        ...
        <div class="form-div" id="divMobile">
            ...
            <div class="schema-form-section row">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                ...
                                <div class="input-field col s4 m4">
                                    <input type="text" id="mobile_reviewerStatus" name="mobile_reviewerStatus" disabled>
                                    <!-- <select id="mobile_reviewerStatus" name="mobile_reviewerStatus" disabled>
                                        <option value="NA">__Select__</option>
                                        <option value="Pending" <?php echo ((isset($mobileStatus) && $mobileStatus == "Pending") ? 'selected' : '') ?>>Pending</option>
                                        <option value="Approve" <?php echo ((isset($mobileStatus) && $mobileStatus == "Approve") ? 'selected' : '') ?>>Approve</option>
                                        <option value="Decline" <?php echo ((isset($mobileStatus) && $mobileStatus == "Decline") ? 'selected' : '') ?>>Decline</option>
                                    </select> -->
                                    <label class="Active" for="mobile_reviewerStatus" class="dropdown-active active">Reviewer:</label>
                                </div>

                                <div class="input-field col s12 m12 l12">
                                    <input type="text" name="mobile_reviewComment" id="mobile_reviewComment" readonly>
                                    <label class="Active" for="mobile_reviewComment">Reviewer Comment</label>
                                </div>

                                <div class="input-field col s4 m4 l4">
                                    <select id="mobile_mgrStatus" name="mobile_mgrStatus">
                                        <option value="NA">Select</option>
                                        <!-- <option value="Pending">Pending</option> -->
                                        <option value="Approve">Approve</option>
                                        <option value="Decline">Decline</option>
                                    </select>
                                    <label for="mobile_mgrStatus" class="dropdown-active active">Approver:</label>
                                </div>

                                <div class="input-field col s12 m12 l12">
                                    <textarea class="materialize-textarea" id="mobile_mgrComment" name="mobile_mgrComment" maxlength="200"></textarea>
                                    <label for="mgrComment">Approver Comment</label>
                                </div>
                ...
                <div id="pnlTable">
                    <?php
                    $sqlConnect = 'SELECT t1.* FROM ems.expense_mobile t1 join EmpID_Name t2 on t1.EmployeeID=t2.empid join expense_matrix t3 on t2.loc=t3.location where t3.EmployeeID="' . $_SESSION['__user_logid'] . '" and is_approver="Yes"';
                    $myDB = new MysqliDb();
                    $result = $myDB->rawQuery($sqlConnect);
                    $mysql_error = $myDB->getLastError();
                    if (empty($mysql_error)) { ?>
                                ...
                                foreach ($result as $key => $value) {
                                    if ($value['reviewerStatus'] == 'Approve' && $value['reviewerStatus'] != 'Decline' && $value['mgrStatus'] != 'Approve' && $value['mgrStatus'] != 'Decline') { ?>
                                        <tr>
                                            ...
                                            <td><?php echo $value['req_status']; ?></td>
                                            <td class="mobilereviewerStatus"><?php echo $value['reviewerStatus']; ?></td>
                                            <td class="mobilereviewComment"><?php echo $value['reviewComment']; ?></td>
                                            <td class=""><?php echo $value['created_at']; ?></td>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn_edit_expenseMobile').on('click', function() {
            var validate = 0;
            var alert_msg = '';
            if ($('#mobile_mgrStatus').val() == 'NA') {
                $('#mobile_mgrStatus').parent('.select-wrapper').find('input.select-dropdown').addClass("has-error");
                if ($('#spanmobile_mgrStatus').length == 0) {
                    $('<span id="spanmobile_mgrStatus" class="help-block">Required *</span>').insertAfter('#mobile_mgrStatus');
                }
                validate = 1;
            }

            if ($('#mobile_mgrComment').val() == '') {
                $('#mobile_mgrComment').addClass("has-error");
                if ($('#spanmobile_mgrComment').length == 0) {
                    $('<span id="spanmobile_mgrComment" class="help-block">Required *</span>').insertAfter('#mobile_mgrComment');
                }
                validate = 1;
            }
    ...
    function EditData_mobile(el) {
        ...
        // var mobilereceipt_img = tr.find('.mobilereceipt_image').text();
        // var divmisc = '<span class="Active">Receipt Image</span><br><a href="../ExpenseMobile/' + mobilereceipt_img + '"target="_blank" download>' + mobilereceipt_img + '</a>';
        var mobileremarks = tr.find('.mobileremarks').text();
        var reviewerStatus = tr.find('.mobilereviewerStatus').text();
        var reviewComment = tr.find('.mobilereviewComment').text();
        ...
        $('#mobile_reviewerStatus').val(reviewerStatus);
        $('#mobile_reviewComment').val(reviewComment);
