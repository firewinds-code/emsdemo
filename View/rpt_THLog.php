...
<span id="PageTittle_span" class="hidden">Training Head Log Report</span>
...
<!-- Header for Form If any -->
	 <h4>Training Head Log Report</h4>				
...
<!--Reprot / Data Table start -->			
		...
		{
			$sqlConnect='call getReport_THLog("'.$date_From.'","'.$date_To.'")';
			$myDB=new MysqliDb();
