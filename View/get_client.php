...
if (isset($_REQUEST['location1'])) {
	...
	$sqlclient = "select distinct t2.client_id,t2.client_name from new_client_master t1 join client_master t2 on t1.client_name=t2.client_id where location='" . $_REQUEST['location1'] . "' and cm_id not in (select cm_id from client_status_master);";
