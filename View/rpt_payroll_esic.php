...
if(isset($_SESSION))
{
	...
	{
		if(!($_SESSION['__user_logid'] == 'CE03070003' || $_SESSION['__user_logid'] == 'CE10091236' || $_SESSION['__user_logid'] == 'CE09134997'))
		{
...
.datepicker_M-table-wrapper, .datepicker_M-date-display {
    display: none;
}	
...
<span id="PageTittle_span" class="hidden"> Locked ESIC Report</span>
