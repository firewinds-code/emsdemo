        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                <div id="pnlTable">
                    ...
                    $selectQry = "select  t1.EmployeeID,t2.EmpName,t3.location,t6.client_name,t5.process,t5.sub_process, address, country, city, state, tehsil, district, zip, latitude, longitude, latlongaddress,  ifnull(t1.modifiedon, t1.createdon) as createdon from address_geo t1 join EmpID_Name t2 on t1.EmployeeID=t2.EmpID  join location_master t3 on t2.loc=t3.id join employee_map t4 on t1.EmployeeID=t4.EmployeeID join new_client_master t5 on t4.cm_id=t5.cm_id join client_master t6 on t5.client_name=t6.client_id WHERE cast(t1.createdon as date) BETWEEN '" . $date_From . "' AND '" . $date_To . "' ";
                    $myDB = new MysqliDb();
