        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if ($__status_er == $emp_id) {
                    $myDB = new MysqliDb1();
                    //echo 'call sp_get_roster_Report_ER("' . $emp_id . '","' . $date_To . '","' . $date_From . '","' . $dept . '")';
                    $chk_task = $myDB->rawQuery('call sp_get_roster_Report_ER("' . $emp_id . '","' . $date_To . '","' . $date_From . '","' . $dept . '")');
...
<script>
    ...
    function downloadexcel(el) {
        ...
        var dept = $('#txt_dept').val();
        var sp = "call sp_get_roster_Report_ER('" + usrid + "','" + date_to + "','" + date_from + "','" + dept + "')";
        //alert(sp);
        //return false;
