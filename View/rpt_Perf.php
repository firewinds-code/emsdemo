...
if(isset($_SESSION))
{
	...
	else if($_SESSION["__status_ah"] =='No')
	{
		$location= URL.'Login'; 
		header("Location: $location");
		exit();
...
<div class="input-field col s12 m12 right-align">			
		...
		if(isset($_POST['btn_view']))
		{
			...
			die;*/
			$chk_task=$myDB->query('call getPer_Report("'.$_SESSION['__user_logid'].'","'.$month.'","'.$year.'","'.$empStatus.'")');
			...
			{  
				...
				$table .='<th>EmployeeID</th>';$table .='<th>EmployeeName</th>';
				$table .='<th>Date</th>';$table .='<th>Acknowledge Date</th>';$table .='<th>Process</th>';$table .='<th>L1</th>';$table .='<th>V1</th>';	
				$table .='<th>L2</th>';$table .='<th>V2</th>';$table .='<th>L3</th>';$table .='<th>V3</th>';$table .='<th>DL4</th>';
				$table .='<th>V4</th>';$table .='<th>L5</th>';$table .='<th>V5</th>';$table .='<th>L6</th>';$table .='<th>V6</th>';
				$table .='<th>L7</th>';$table .='<th>V7</th>';$table .='<th>L8</th>';$table .='<th>L8</th>';$table .='<th>L9</th>';
				$table .='<th>V9</th>';$table .='<th>L10</th>';$table .='<th>V10</th>';$table .='<th>L11</th>';$table .='<th>V11</th>';
				$table .='<th>L12</th>';$table .='<th>V12</th>';$table .='<th>L13</th>';$table .='<th>V13</th>';$table .='<th>L14</th>';
				$table .='<th>V14</th>';$table .='<th>L15</th>';$table .='<th>V15</th><thead><tbody>';
				    
				foreach($chk_task as $key=>$value)
				{
					
					$table .='<tr><td>'.$value['EmployeeID'].'</td>';$table .='<td>'.$value['EmployeeName'].'</td>';
					$table .='<td>'.$value['DateFor'].'</td>';$table .='<td>'.$value['Acknowledge_date'].'</td>';$table .='<td>'.$value['Process'].'</td>';
					$table .='<td>'.$value['L1'].'</td>';$table .='<td>'.$value['V1'].'</td>';$table .='<td>'.$value['L2'].'</td>';
					$table .='<td>'.$value['V2'].'</td>';$table .='<td>'.$value['L3'].'</td>';$table .='<td>'.$value['V3'].'</td>';
					$table .='<td>'.$value['L4'].'</td>';$table .='<td>'.$value['V4'].'</td>';$table .='<td>'.$value['L5'].'</td>';
					$table .='<td>'.$value['V5'].'</td>';$table .='<td>'.$value['L6'].'</td>';$table .='<td>'.$value['V6'].'</td>';
					$table .='<td>'.$value['L7'].'</td>';$table .='<td>'.$value['V7'].'</td>';$table .='<td>'.$value['L8'].'</td>';
					$table .='<td>'.$value['V8'].'</td>';$table .='<td>'.$value['L9'].'</td>';$table .='<td>'.$value['V9'].'</td>';
					$table .='<td>'.$value['L10'].'</td>';$table .='<td>'.$value['V10'].'</td>';$table .='<td>'.$value['L11'].'</td>';
					$table .='<td>'.$value['V11'].'</td>';$table .='<td>'.$value['L12'].'</td>';$table .='<td>'.$value['V12'].'</td>';
					$table .='<td>'.$value['L13'].'</td>';$table .='<td>'.$value['V13'].'</td>';$table .='<td>'.$value['L14'].'</td>';
					$table .='<td>'.$value['V14'].'</td>';$table .='<td>'.$value['L15'].'</td>';$table .='<td>'.$value['V15'].'</td></tr>';
