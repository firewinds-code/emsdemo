...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Hathway Report</span>
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['view'])) {
                    $myDB = new MysqliDb();
                    $conn = $myDB->dbConnect();
                    $sqlConnect = "select EmployeeID, EmpName,designation,createdon from hathway_decl where cast(createdon as date) between ? and ? order by createdon";
