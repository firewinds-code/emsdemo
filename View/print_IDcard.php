...
if ($_SESSION['__user_logid'] == 'CE111930187' ||  $_SESSION['__user_logid']=='CE03070003' ||  $_SESSION['__user_logid']=='CE01145570' ||  $_SESSION['__user_logid']=='CE071829465')
{
...
$sql="select a.EmployeeID, a.EmployeeName, a.DOB, a.DOJ, concat(a.clientname,' | ',a.Process,' | ',a.sub_process) as newprocess,  a.account_head,a.designation, a.ReportTo ,b.ID_Card from whole_details_peremp a  inner JOIN  doc_al_status b on a.EmployeeID=b.EmployeeID where  b.ID_Card='".$icardStatus."' and a.DOJ between '".$date_From."' and '".$date_To."' ";		
?>
...
<div class="input-field col s12 m12" id="rpt_container">
		...
		<div class="input-field col s3 m3">
			<select name="icardStatus"  id="icardStatus" >
				<option value="0" <?php if($icardStatus=='0'){echo "selected"; } ?>>Not Issued</option>
				<option value="1"  <?php if($icardStatus=='1'){echo "selected"; } ?> >Issued</option>
			</select>
		</div>
		<div class="input-field col s3 m3">			
			    ...
			    <tbody>					        
			       ...
			       if(count($result)>0){
			        foreach($result as $key=>$value){
						...
						<?php if($value['ID_Card']==1){ echo 'Issued';}else{
							echo 'Not Issued';
						} ?>
