...
$imsrc_ah = $imsrc_rt = $imsrc_oh= $imsrc_qh=$imsrc_th=$imsrc_qa=$ctc= $esi_no= $ctcRange='';
		    ...
		    <!--Management Map-->
		      ...
		      <div id="management_div" class="list-container">
					<?php 
						if(isset($_REQUEST['empid'])||$EmployeeID!='')
						{
$getDetails2="select EmployeeName,designation,EmployeeID,mobile from emp_dt_map where EmployeeID in ('CE03070003','CE07147134')";
							$myDB=new MysqliDb();
							...
							if(empty($MysqliError)){
								echo '<table class="responsive-table">';
								echo '<tr>';
								echo "<td >".$n1."</td><td  style='padding-left: 5px;vertical-align: middle;line-height: 40px;'>".'<img  id="designation_id" name="designation_id" class="emp_image" src="../Style/images/agent-icon.png"  style="height: 40px;width: 40px;border-radius: 10px;"/>'."&nbsp;&nbsp;<b>".$a;
								if(!empty($b))
								{
									echo '&nbsp;&nbsp;(&nbsp;'.$b.'&nbsp;)';
								}
								...
								echo "<td >".$n2."</td><td  style='padding-left: 5px;vertical-align: middle;line-height: 40px;'>".'<img  id="designation2_id" name="designation2_id" class="emp_image" src="../Style/images/agent-icon.png"  style="height: 40px;width: 40px;border-radius: 10px;"/>'."&nbsp;&nbsp;<b>".$c;
								if(!empty($d))
								{
									echo '&nbsp;&nbsp;(&nbsp;'.$d.'&nbsp;)';
								}
