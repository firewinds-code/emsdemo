		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				if (isset($_POST['btn_view'])) {
					...
					$sqlConnect = "select distinct(cr.EmployeeID),c.EmpName,c.client,c.process,c.sub_process, cr.reason,cr.month,cr.created_at,cr.per_email_id from salary_certificate_report cr left Join salary_certificate c on c.Empid=cr.EmployeeID where created_at between '" . $date_From . "' and '" . $date_To . "' order by created_at";
					$myDB = new MysqliDb();
