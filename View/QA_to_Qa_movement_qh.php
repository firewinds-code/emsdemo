...
if(isset($_POST['btn_approve']) && $_POST['btn_approve'])
{
...
<!-- Form container if any -->
	<div class="schema-form-section row" >
		<div class="input-field col s10 m10 ">
			<?php
			$sqlBy ="select distinct Process from tbl_qa_to_qa_movement where EmployeeID in (select EmployeeID from whole_details_peremp where qh = '".$_SESSION['__user_logid']."')"; 
			$myDB=new MysqliDb();
