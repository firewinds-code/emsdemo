...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Den Declaration Report</span>
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn_view'])) {
                    ...
                    <div id="pnlTable">
                        ...
                        $sqlConnect = "select EmployeeID,EmpName,Address,fathername,designation,mobile,createdon from den_decl where cast(createdon as date) between ? and ?";
