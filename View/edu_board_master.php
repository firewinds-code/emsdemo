					    ...
					    <tbody>					        
					       ...
					       $i=1;
					        foreach($result as $key=>$val){
								...
								<a onclick="editData('<?php echo $ID; ?>','<?php echo $val['board']; ?>');" ><i class="material-icons edit_item imgBtn imgBtnEdit tooltipped" data-position="left" data-tooltip="Edit">ohrm_edit</i></a></td>
