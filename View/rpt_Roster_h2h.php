            ...
            <div class="schema-form-section row">
                ...
                <div id="myModal_content" class="modal">
                    ...
                    <div class="modal-content" style="height: 295px;">
                        <h4 class="col s12 m12 model-h4">Roster Report</h4>
                ...
                $myDB = new MysqliDb1();
                //echo 'call sp_get_roster_Report_h2h("' . $emp_id . '","' . $date_To . '","' . $date_From . '","' . $dept . '")';
                $chk_task = $myDB->rawQuery('call sp_get_roster_Report_h2h("' . $emp_id . '","' . $date_To . '","' . $date_From . '","' . $dept . '")');
                // echo 'call sp_get_atnd_Report_ER("' . $emp_id . '","' . $date_To . '","' . $date_From . '","' . $dept . '")';
...
<script>
    ...
    function downloadexcel(el) {
        ...
        var dept = $('#txt_dept').val();
        var sp = "call sp_get_roster_Report_h2h('" + usrid + "','" + date_to + "','" + date_from + "','" + dept + "')";
        //alert(sp);
        //return false;
