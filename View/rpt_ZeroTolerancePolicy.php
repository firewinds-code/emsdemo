...
$client_id=$_SESSION['__user_client_ID'];
if(!isset($_SESSION['__user_logid']) || $_SESSION['__user_client_ID']!='40' || $_SESSION['__status_ah']=='' || ($_SESSION['__user_logid']!=$_SESSION['__status_ah']) )
	{
		$location= URL.'Login'; 
...
<script>
	$(function(){
		...
		//	$sqlConnect="select a.EmployeeID, b.EmployeeName,b.location, a.ack_date from zerotolerancepolicy_ack a Inner Join personal_details b on a.EmployeeID=b.EmployeeID";
			$sqlConnect="select a.EmployeeID, b.EmployeeName,b.location ,a.ack_date from zerotolerancepolicy_ack a Inner Join whole_details_peremp b on a.EmployeeID=b.EmployeeID and b.account_head='".$_SESSION['__status_ah']."' and b.client_name='40';";
