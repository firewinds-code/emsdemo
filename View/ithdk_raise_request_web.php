	...
	<!--Form element model popup start-->
		<div class="input-field col s12 m12" >
			...
			<div class="col s6 m6" id = "empInfo" style ="display:none">			
					 ...
					 <?php 
						$sqlBy ="select mobile,ofc_emailid from contact_details where EmployeeID = '".$_SESSION["__user_logid"]."' limit 1"; 
						$myDB=new MysqliDb();
		...
		<div class="col s12 m12 right-align">		
			<button  class="btn waves-effect waves-green" name="btn_submit" id="btn_submit" value="Submit"/> Submit</button>
		</div>
	</div>
	<!--Form container End -->	
    </div>     
...
$('#btn_submit').on('click', function(){
	...
	if(isError == 1){
		...
		return false;
		 ...
		 data: {"handlerEmpId": handlerEmpId, "requesterEmpId": requesterEmpId,"client": client.toString(), "priorty": priority, "process": processName, "category": categories1, "issueType": issueType, "location": location, "tat": tat,"totalAgents":totalAgents, "agentImpacted": agentImpacted, "issueDisc": issueDesc, "handlerName": handlerName, "handlerEmail": handlerEmail, "handlerMobile": handlerMobile, "appkey": "raise_ticket"}
		}).done(function(data) {
