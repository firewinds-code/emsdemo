			...
			<div class="schema-form-section row">
				...
				<div id="pnlTable">
					...
					function getEmpName($empID)
					{
						...
						$rowCount = $myDB->count;
						return $select_empname_query[0]['EmployeeName'];
					}
					if (isset($_POST['from_date'], $_POST['to_date']) and $_POST['from_date'] != "") {
						$date_string = "  b.AttemptedDate BETWEEN '" . $_POST['from_date'] . "' AND '" . $_POST['to_date'] . " 23:59:59' ";
						...
						if ($_SESSION["__user_type"] != 'ADMINISTRATOR' and $_SESSION["__user_type"] != 'CENTRAL MIS') {
							$sqlConnect .= " a.CreatedBy='" . $_SESSION['__user_logid'] . "' and ";
						}
