...
$rs_emp = $myDB->query("select t2.des_id,dateofjoin as DOJ,EmployeeID from employee_map t1 join df_master t2 on t1.df_id=t2.df_id where t1.emp_status='Active' and EmployeeID='CE0123949527'  ");
