...
//die;
if ($__status_er == $clean_u_logid && $clean_u_logid != "CE021929762") {
    $condition =  " where ep.cm_id in (select cm_id from new_client_master where er_scop='" . $__status_er . "') ";
} else if ($clean_u_logid == "CE021929762") {
    $condition =  "";
}
            ...
            <div id="pnlTable">
                ...
                ?>
                    <div class="had-container pull-left row card" style="margin-top: 10px;width: 100%;padding: 15px;">
                        <table id="myTable_ER" class="data dataTable no-footer row-border" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<tr><td colspan='20'>Data not found</td></tr>";
                                }
                                ?>
                            </tbody>
                        </table>
