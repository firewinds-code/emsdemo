...
if (isset($_SESSION)) {
	...
	} else if ($_SESSION['__user_logid'] == 'CE01145570') {
		// proceed further
	} else {
		$location = URL;
...
<div id="content" class="content">
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<h4>Upload Biometric<!--<a class="btn-floating btn-large waves-effect waves-light modal-trigger tooltipped"  href="#myModal_content" data-position="bottom" data-tooltip="Download Formate"><i class="material-icons">file_download</i></a>--></h4>
