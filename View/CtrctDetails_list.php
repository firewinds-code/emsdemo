...
$ack=$vh_ack=$oh_ack='';
 if(($_SESSION['__status_ah']!='No' && $_SESSION['__status_ah']==$_SESSION['__user_logid'] && $_SESSION['__status_ah']!='') || ($_SESSION["__status_vh"]==$_SESSION['__user_logid']) || $_SESSION["__user_logid"] == 'CE091930141'){
 	$myDB=new MysqliDb();
...
<!-- Form container if any -->
	<div class="schema-form-section row" >
		...
		<div id="eduFormid" class="hidden" >
				...
				if($_SESSION['__user_logid']!='CE10091236' && $_SESSION['__user_logid']!='CE091930141' ){
					//
