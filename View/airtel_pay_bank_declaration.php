...
$sqlquery = "select t1.EmpID,t1.EmpName,address_p,FatherName, case when df_id=74 or df_id=77 then 'Agent' else 'Support Staff' end as desig from EmpID_Name t1 join employee_map t2 on t1.EmpID=t2.EmployeeID join address_details t5 on t2.EmployeeID=t5.EmployeeID where t2.EmployeeID= ?";
...
if (isset($_POST['btnSave'])) {
    $source = 'Web';
    $query = "insert into airtel_pay_bank_decl (EmployeeID, EmpName,Address,fathername,designation,source) values(?,?,?,?,?,?) ";
...
<div id="content" class="content">
    ...
    <span id="PageTittle_span" class="hidden">Airtel Payment Bank Declaration</span>
    ...
    <div class="pim-container row" id="div_main">
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                <p style="padding-top: 25px;"> This is to confirm that I <b><?php echo $EmployeeName; ?></b> resident of <b><?php echo $add  ?></b> S/O, D/O <b><?php echo  $fathername  ?></b> am working as <b><?php echo $desig  ?></b> Airtel Payment Bank Limited. </p>
                ...
                <p> &nbsp; &nbsp;&nbsp;&nbsp; b) b)Will ensure no information pertaining to the process is shared to anyone who is not a part of AIRTEL PAYMENT BANK process </p>
                ...
                <p><br />Employee Name <br /><br /> <b><span><?php echo $EmployeeName; ?></b></span></p>
