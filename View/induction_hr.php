...
if ($user_logid == 'CE10091236' || $user_logid == 'CE12102224' || $user_logid == 'CE0122942656' || $user_logid == 'CE03070003' || $user_logid == 'CE021929762' || $user_logid == 'CE1121941390 ' || $user_logid == 'CE1021940627' || $user_logid == 'CE1121941390') {
    // proceed further
} else {
    $location = URL;
        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['btn_search'])) {
                    ...
                    $sqlConnect = "select t8.location,t1.EmpID,t2.EmployeeName,t7.Designation,t3.dateofjoin,t5.client_name,t4.process,t4.sub_process from induction_master t1 join personal_details t2 on t1.EmpID=t2.EmployeeID join employee_map t3 on t1.EmpID=t3.EmployeeID left join new_client_master t4 on t4.cm_id=t3.cm_id left join client_master t5 on t5.client_id=t4.client_name left join df_master t6 on t6.df_id=t3.df_id left join designation_master t7 on t7.ID=t6.des_id left join location_master t8 on t8.id=t2.location where EmpFlag=0 and t3.emp_status='Active' and(t3.dateofjoin between ? and ?) order by dateofjoin";
