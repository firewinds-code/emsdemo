		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<div class="input-field col s5 m5 clsIDHome">
					...
					<input type='text' name='from_date' id='from_date' <?php if (isset($_POST['from_date'])) { ?> value="<?php echo $_POST['from_date']; ?>" <?php } ?> readonly="true">
				...
				<div id="pnlTable">
					...
					if (isset($_POST['from_date'], $_POST['to_date']) and $_POST['from_date'] != "") {
						...
						$sqlConnect = "select a.old_cm_id,a.new_cm_id,a.status,a.flag,  a.EmployeeID,a.move_date,w.EmployeeName,w.DOJ, a.created_on,a.AH_updated_on,a.HR_updated_on,a.updated_on,b.cm_id,c.client_name,b.process,b.sub_process,b.account_head,e.client_name as client_name_o ,d.process as process_o,d.sub_process as sub_process_o ,d.account_head as account_head_o,l1.location FROM tbl_client_toclient_move a inner join whole_dump_emp_data w on a.EmployeeID=w.EmployeeID INNER JOIN new_client_master b on a.new_cm_id=b.cm_id INNER JOIN client_master c ON c.client_id=b.client_name INNER JOIN new_client_master d on a.old_cm_id=d.cm_id INNER JOIN client_master e ON e.client_id=d.client_name join location_master l1 on l1.id = w.location where a.created_on BETWEEN '" . $_POST['from_date'] . "' AND '" . $_POST['to_date'] . " 23:59:59' order by a.id desc";
						/*if($_SESSION["__location"]=="1")
		{
			$sqlConnect= "select a.old_cm_id,a.new_cm_id,a.status,a.flag,  a.EmployeeID,a.move_date,w.EmployeeName,w.DOJ, a.created_on,a.AH_updated_on,a.HR_updated_on,a.updated_on,b.cm_id,c.client_name,b.process,b.sub_process,b.account_head,e.client_name as client_name_o ,d.process as process_o,d.sub_process as sub_process_o ,d.account_head as account_head_o FROM tbl_client_toclient_move a inner join whole_details_peremp w on a.EmployeeID=w.EmployeeID INNER JOIN new_client_master b on a.new_cm_id=b.cm_id INNER JOIN client_master c ON c.client_id=b.client_name INNER JOIN new_client_master d on a.old_cm_id=d.cm_id INNER JOIN client_master e ON e.client_id=d.client_name where a.created_on BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']." 23:59:59' and w.location in (1,2) order by a.id desc";
		}
		else
		{
			$sqlConnect= "select a.old_cm_id,a.new_cm_id,a.status,a.flag,  a.EmployeeID,a.move_date,w.EmployeeName,w.DOJ, a.created_on,a.AH_updated_on,a.HR_updated_on,a.updated_on,b.cm_id,c.client_name,b.process,b.sub_process,b.account_head,e.client_name as client_name_o ,d.process as process_o,d.sub_process as sub_process_o ,d.account_head as account_head_o FROM tbl_client_toclient_move a inner join whole_details_peremp w on a.EmployeeID=w.EmployeeID INNER JOIN new_client_master b on a.new_cm_id=b.cm_id INNER JOIN client_master c ON c.client_id=b.client_name INNER JOIN new_client_master d on a.old_cm_id=d.cm_id INNER JOIN client_master e ON e.client_id=d.client_name where a.created_on BETWEEN '".$_POST['from_date']."' AND '".$_POST['to_date']." 23:59:59' and w.location in ('".$_SESSION["__location"]."') order by a.id desc";
		}*/
