 <?php
    ...
    //$EmployeeID = $EmpID = strtoupper($_SESSION["__user_logid"]);
    $EmployeeID = $EmpID = 'CE0722946358';
    $location = URL . 'Error';
 ...
 <?php
    ...
    if (isset($_POST['emailAddress']) && trim($_POST['emailAddress']) != "") {
        ...
        $GetData = "select whole_details_peremp.EmployeeID,EmployeeName,location,DOJ,designation,ctc,status_table.onFloor,des_id,whole_details_peremp.function,Gender,tehsil from whole_details_peremp left outer join salary_details on salary_details.EmployeeID = whole_details_peremp.EmployeeID left outer join status_table on whole_details_peremp.EmployeeID = status_table.EmployeeID left join address_details on whole_details_peremp.EmployeeID = address_details.EmployeeID where whole_details_peremp.EmployeeID='" . $EmployeeID . "'";
        //Flag=0";
        $myDB = new MysqliDb();
        ...
        if (count($resultsE) > 0) {
            foreach ($resultsE as $val) {
                ...
                if ($loc == "3") {
                    ...
                    $target_dir = ROOT_PATH . "Nashik/appointpdf/";
                } else if ($loc == "9") {
                    $target_dir = ROOT_PATH . "Anantapur/appointpdf/";
                } else if ($loc == "10") {
                    $target_dir = ROOT_PATH . "Gurgaon/appointpdf/";
                } else if ($loc == "11") {
                    $target_dir = ROOT_PATH . "Hyderabad/appointpdf/";
                }
                ...
                $flag = 0;
                if (in_array($var_desg_id, array(9, 12, 33, 34, 35, 36))) //For CSA Only 
                {
                    $flag = 1;
...
<p>We are pleased to appoint you in <b>" . $companyname . "</b> (<i>hereafter referred to as</i> <b>“Company”</b>) as  '" . $designation . "'  as per the employment terms and conditions stated below. Please note that the employment terms contained in this letter are subject to Company policy.</p>

<p>Your effective date of appointment is " . $DOJ . ". The term of your employment with the Company shall commence on the effective date and shall continue unless this Appointment Letter is withdrawn by cogent in accordance with the terms of separation mentioned in this letter. </p>
...
p{
    ...
    <dt><b>1. Compensation-</b>Your cost to the company (CTC) will be INR (" . $annual . ") annually.</dt>
    <br>
    ...
    <dt><b>3. E-Induction-</b> You will be a part of the e-induction procedure to make you familiar with the Company policies and day-to-day working. 
    </dt>
    <br>

    <dt><b>4. Assignment / Transfer-</b>Your daily place of work will be " . $Locationresult[0]['location'] . ". However, during your service with the Company you are liable to be posted/ transferred to specific projects, assignments, jobs, etc. in which case you will be required to perform your services at such location, division, department, or branch of the Company as the Company may deem fit.
    </dt>
    <br>
    ...
    <dd>5.3 You shall act loyally and faithfully to the Company and obey the instructions of the management of the Company.
    </dd>

    <dd>5.4 You shall always maintain high standards of secrecy of confidential records, documents and information relating to the business which may become known to you and shall use them always in the best interest of the company. You shall upon end of your services to the company for any </dd>
    <br>";
    ...
    <br>
    <dt><b>6. Code of Conduct- </b>You shall always abide by the rules and regulations as per the code of conduct of the Company which may be amended from time to time.</dt>
    <br>
    <dt><b>7. Dress Code-</b> Company has adopted “Smart Casual” as its Dress Code. Employees irrespective of gender should ensure that they are dressed in decent wear to appear professional.</dt>
    <br>
    ...
    <br>
    <dt><b>9. Leave-</b> You will be eligible for the benefits of leave as per the Company policy available on the EMS. </dt>
    <br>
    <dt><b>10. Termination on account of fraud, misconduct or Zero Tolerance Policy:</b></dt>
            <dd>10.1 Under exceptional circumstances if it comes to the notice of the Company that an employee is not abiding by the prescribed Code of Conduct or is not executing his/her duties and if such action is likely to cause harm to the business or adversely affect the Company’s reputation, then the Company on its own discretion can terminate the services of the employee without notice. 
            </dd>
            <dd>10.2 The decision of the Company with regards to termination will be final and legally binding on the employee. In all such cases, Company shall not be liable to pay any dues and termination letter will be issued. 
            </dd>
            <dd>10.3 If at any time in the opinion of the Company an employee is found guilty on any of the grounds mentioned below, the company may terminate the services immediately and claim for suitable damamges -
                    <dd>a. Dishonesty in carrying out duties or deliberate commission of a crime against the Company or its clients.
                    </dd>
                    
                    <dd>b. Fraud, theft, or gross malfeasance on the part of the employee; conduct of any activity which is criminal in     nature; conduct or involve in misappropriation of Company assets.
                    </dd>
                    <dd>c. Use of drugs and intoxicants.
                    </dd>
                    <dd>d. Violation of any terms of this letter of Appointment.
                    </dd>
                    <dd>e. Repeated violation by the employee of any written policies of the Company.
                    </dd>
...
<br> ";
        ...
        <dt><b>11. Unauthorized Absence- </b>If an employee absents himself /herself without information for more than 3 days or remains absent beyond the period of the originally granted leave, he/she shall be considered as absconding and company shall not be liable to pay any dues or release any documents. 
        </dt>
        <br>
        <dt><b>12. Resignation / Separation-</b> When an employee intends to pursue work else where, he/she shall submit a written resignation and provide services of minimum 30 days as per the defined notice period. Post the manager’s and HR department’s approval the employee's resignation will be processed. In all such cases, Company shall, be liable to pay all dues and relieving & experience letter will be issued.
        </dt>
        <br>
        <dt><b>13. Notice Period-</b> As per the Company policy, any employee in the event of resignation due to any reason will be required to serve 30 days’ notice period. The Company may, in its sole discretion, terminate the employment due to business contingencies, by giving 30 days’ notice or salary in lieu thereof.
        </dt>
        <br>
        <dt><b>14. Restrictions for representing the Company after end of employment -</b> You shall not anywhere at any time after the end of employment with company either personally or through your agents/friends / relatives directly or indirectly represent yourself as being connected in any way with the business of the Company.
        </dt>
        <br>
        <dt><b>15. Handing over the Company’s Property at the time of separation-</b> In the event of separation for any reason whatsoever, you must return all the Company’s property including but not limited to identity card, visiting cards, all details, and records of customers as maintained by you, laptop /desktop (if issued), reports, letters, notebooks, programs, proposal and any documents / copies or any confidential information concerning the Company’s business. This data may be physical or digital in nature.
        </dt>
        <br>
        ...
        <br>
        <dt><b>17. Jurisdiction- </b>This is agreed by both parties (Employees and Company) that only the courts of Delhi shall have exclusive jurisdiction in respect of any matter, claim, dispute arising out of or in any way, relating to this letter. 
        </dt>
        <br>
        <dt><b>18. Exclusive Service-</b> While with the Company you will not work for any other Company or person, nor carry any material / service for promotion of any other Company. 
        </dt>
        <br>
...
p{
    ...
    <br>
    <dt><b>4. E-Induction-</b> You will be a part of the e-induction procedure to make you familiar with the Company policies and day-to-day working.</dt>
    <br>
    ...
    ";
        ...
        <dt><b>6. Duties & Obligation-</b>    
            ...
            <dd>6.3 You shall act loyally and faithfully to the Company and obey the instructions of the management of the Company.
            </dd>

            <dd>6.4 You shall always maintain high standards of secrecy of confidential records, documents and information relating to the business which may become known to you and shall use them always in the best interest of the company. You shall upon end of your services to the company for any reason, return all such records in your possession and shall not attempt to retain copies of any data records or information of the Company.
            </dd>
    ...
    <br>
    <dt><b>7. Code of Conduct- </b>You shall always abide by the rules and regulations as per the code of conduct of the Company which may be amended from time to time.
    </dt>
    <br>
    <dt><b>8. Dress Code-</b> Company has adopted “Smart Casual” as its Dress Code. Employees irrespective of gender should ensure that they are dressed in decent wear to appear professional.
    </dt>
    <br>
    ...
    <br>
    <dt><b>10. Leave-</b> You will be eligible for the benefits of leave as per the Company policy available on the EMS.
    </dt>
    <br>
    <dt><b>11. Termination on account of fraud, misconduct or Zero Tolerence Policy:</b></dt>
            <dd>11.1 Under exceptional circumstances if it comes to the notice of the Company that an employee is not abiding by the prescribed Code of Conduct or is not executing his/her duties and if such action is likely to cause harm to the business or adversely affect the Company’s reputation, then the Company on its own discretion can terminate the services of the employee without notice. 
            </dd>
            <dd>11.2 The decision of the Company with regards to termination will be final and legally binding on the employee. In all such cases, Company shall not be liable to pay any dues and termination letter will be issued. 
            </dd>
            <dd>11.3 If at any time in the opinion of the Company an employee is found guilty on any of the grounds mentioned below, the company may terminate the services immediately and  
            </dd> ";
       ...
       <dd> claim for suitable damamges -</dd>
                    <dd>a. Dishonesty in carrying out duties or deliberate commission of a crime against the Company or its clients.
                    </dd>
                    <dd>b. Fraud, theft, or gross malfeasance on the part of the employee; conduct of any activity which is criminal in nature; conduct or involve in misappropriation of Company assets.
                    </dd>
...
<br>
        <dt><b>12. Unauthorized Absence- </b>If an employee absents himself /herself without information for more than 3 days or remains absent beyond the period of the originally granted leave, he/she shall be considered as absconding and company shall not be liable to pay any dues or release any documents. 
        </dt>
        <br>
        <dt><b>13. Resignation / Separation-</b> When an employee intends to pursue work else where, he/she shall submit a written resignation and provide services of minimum 30 days as per the defined notice period. Post the manager’s and HR department’s approval the employee's resignation will be processed. In all such cases, Company shall, be liable to pay all dues and relieving & experience letter will be issued.
        </dt>
        <br>
        <dt><b>14. Notice Period-</b> As per the Company policy, any employee in the event of resignation due to any reason will be required to serve 30 days’ notice period. The Company may, in its sole discretion, terminate the employment due to business contingencies, by giving 30 days’ notice or salary in lieu thereof.
        </dt>
        <br>
        <dt><b>15. Restrictions for representing the Company after end of employment -</b> You shall not anywhere at any time after the end of employment with company either personally or through your agents/friends / relatives directly or indirectly represent yourself as being connected in any way with the business of the Company.
        </dt>
        <br>
        ...
        <br>
        <dt><b>18. Jurisdiction- </b>This is agreed by both parties (Employees and Company) that only the courts of Delhi shall have exclusive jurisdiction in respect of any matter, claim, dispute arising out of or in any way, relating to this letter. 
        </dt>
        <br><br><br><br>";
        ...
        <dt><b>19. Exclusive Service-</b> While with the Company you will not work for any other Company or person, nor carry any material / service for promotion of any other Company. 
        </dt>
        <br>
...
<p>We are pleased to appoint you in <b>Cogent E Services Limited</b> (<i>hereafter referred to as</i> <b>“Company”</b>) as  '" . $designation . "' as per the employment terms and conditions stated below. Please note that the employment terms contained in this letter are subject to Company policy.</p>
...
p{
    ...
    <dt><b>2. Performance Linked Incentives (PLI)–</b> Your Cost to Company (CTC) will include a 10% Performance Linked Incentive which shall be paid out basis successful achievement of the set performance standards.<br>The PLI shall be paid yearly.<br> Please note that the PLI will be payable only if you are still on the company rolls on the date of disbursement.<br>PLI will not be payable, if you are not on Company rolls, have resigned or are serving notice period on the date of disbursement.</dt>
    
    <br>
    <dt><b>3. Service Conditions-</b> You shall be governed by the rules and regulations and such other practices, systems, procedures, and policies in existence or established by the Company from time to time. 
    </dt>
    <br>
    <dt><b>4. E-Induction-</b> You will be a part of the e-induction procedure to make you familiar with the Company policies and day-to-day working. 
    </dt>
    <br>
    <dt><b>5. Assignment / Transfer-</b>Your daily place of work will be " . $Locationresult[0]['location'] . ". However, during your service with the Company you are liable to be posted/ transferred to specific projects, assignments, jobs, etc. in which case you will be required to perform your services at such location, division, department, or branch of the Company as the Company may deem fit.
    </dt>
    ...
    <br>
    <dt><b>11. Termination on account of fraud, misconduct or Zero Tolerance Policy:</b></dt>
            <dd>11.1 Under exceptional circumstances if it comes to the notice of the Company that an employee is not abiding by the prescribed Code of Conduct or is not executing his/her duties and if such action is likely to cause harm to the business or adversely affect the Company’s reputation, then the Company on its own discretion can terminate the services of the employee without notice. 
            </dd>
            <dd>11.2 The decision of the Company with regards to termination will be final and legally binding on the employee. In all such cases, Company shall not be liable to pay any dues and termination letter will be issued. 
            </dd>
            <dd>11.3 If at any time in the opinion of the Company an employee is found guilty on any of the grounds mentioned below, the company may terminate the services immediately and claim for suitable damamges -
            </dd> ";
            ...
            if ('OC' == substr($EmployeeID, 0, 2)) {
                ...
                $tcpdf->Image('../Style/images/cogent-logoNW.png', 160, 5, 40, 30, 'JPG'); //logo right cogent logo
                    ...
                    if ($rowCount > 0) {
                        ...
                        $email_address = 'md.masood@cogenteservices.com';
                    ...
                    if (file_exists($path)) {
                        ...
                        $body = '<style>table {    border-collapse: collapse;}table, td, th {border: 1px solid black;padding:5px;text-align: center;}table th{border-bottom: 2px solid black;}</style><span>Dear ' . $Gender . ' ' . $EmployeeName . '  ,<br/><br/><span><b> Please find attached your appointment letter</b></span><br /><br/><div style="float:left;width:100%;"><br/> Yours truly <br/> HR Team <br/> Cogent E Services Limited. <br/><br/><div>';
