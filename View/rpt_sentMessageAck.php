	...
	<div class="input-field col s12 m12" id="rpt_container">
		...
		<?php
			if(isset($_POST['btn_view']))
			{
				...
				$chk_task=$myDB->query("select a.text_msg,a.msg_date,a.to_empid,a.`status`,a.ackstatus,a.acknowledgedate,acknowledge as ackremark,  w.EmployeeName,w.clientname,w.`Process`,sub_process from tbl_chat_message a left join whole_dump_emp_data w on a.to_empid=w.EmployeeID where a.acknowledgedate between '".$date_From."'  and '".$date_To."' ");
