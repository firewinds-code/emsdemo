...
{
	$_Name=(isset($_POST['txt_Announcement_Name'])? $_POST['txt_Announcement_Name'] : null);
	$_Body=(isset($_POST['txt_Announcement_Body'])? $_POST['txt_Announcement_Body'] : null);
...
<!-- Header for Form If any -->
	 <h4>Announcement Master Details
        ...
        <a class="btn-floating btn-large waves-effect waves-light modal-trigger tooltipped" id="ContentAdd" href="#myModal_content" data-position="bottom" data-tooltip="Add Announcement"><i class="material-icons">add</i></a></h4>				
