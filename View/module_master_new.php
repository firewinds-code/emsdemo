...
if(isset($_POST['addMaster']))
{
	...
	$_txt_matrixtype=(isset($_POST['txt_matrixtype'])? $_POST['txt_matrixtype'] : null);
	$_txt_location=(isset($_POST['txt_location'])? $_POST['txt_location'] : null);
	$_txt_Process=(isset($_POST['txt_Process'])? $_POST['txt_Process'] : null);
	$_txt_Module=(isset($_POST['txt_Module'])? $_POST['txt_Module'] : null);
	$_txt_Level=(isset($_POST['txt_Level'])? $_POST['txt_Level'] : null);
	$_txt_empid=(isset($_POST['txt_empid'])? $_POST['txt_empid'] : null);
	...
	if($_txt_Level == "2")
	{
		$EmpID2 = substr($_POST['txt_empid1'],strpos($_POST['txt_empid1'],"(")+1,(strpos($_POST['txt_empid1'],")")) - (strpos($_POST['txt_empid1'],"(")+1));
		$EmpName2 = substr($_POST['txt_empid1'],0,strpos($_POST['txt_empid1'],"(")-1);
	}
	...
	{
		$EmployeeID = substr($_POST['txt_empid2'],strpos($_POST['txt_empid2'],"(")+1,(strpos($_POST['txt_empid2'],")")) - (strpos($_POST['txt_empid2'],"(")+1));
