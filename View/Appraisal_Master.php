...
if (isset($_POST['btn_AprMaster_Save'])) {
	$_cmid = (isset($_POST['txt_Client']) ? $_POST['txt_Client'] : null);
	$_EmpID = (isset($_POST['txt_EmpID']) ? $_POST['txt_EmpID'] : null);
...
if (isset($_POST['btn_AprMaster_Edit'])) {
	$DataID = $_POST['hid_ID'];
...
<div id="content" class="content">
	...
	<div class="pim-container row" id="div_main">
		<div class="form-div">
			<h4>Appraisal Master <a class="btn-floating btn-large waves-effect waves-light modal-trigger tooltipped" id="ContentAdd" href="#myModal_content" data-position="bottom" data-tooltip="Add"><i class="material-icons">add</i></a></h4>
...
<script>
	...
	function getProcess(el) {
		$.ajax({
			url: <?php echo '"' . URL . '"'; ?> + "Controller/getProcessNameByLocation.php?id=" + $(this).val()
		}).done(function(data) { // data what is sent back by the php page
			$('#txt_Client').html(data);
			$('select').formSelect();
		});
