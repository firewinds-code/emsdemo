...
if(isset($_SESSION))
{
	...
	if($_SESSION['__user_logid']!='CE10091236' && $_SESSION['__user_logid']!='CE03070003' )
	{
		$location= URL.'Login'; 
...
if(isset($_SESSION['__user_logid']) )
{
	...
	if(isset($_POST['btnSave']))
	{
		...
		if(isset($_POST['btnEdit']))
		{
			...
			$Id=$_POST['editId'];
			//$incentiveStatus="1";
			$incentiveStatus=$_POST['incentiveStatus'];
...
<!-- Form container if any -->
	...
	<div  class="input-field col s4 m4 ">
	      <select   id="incentiveStatus"  name="incentiveStatus"  >
	      	<option value="0"<?php if($Id!="" and $incentiveStatus==0){ echo "selected='selected'";}?> >Inactive</option> 
	      	<option value="1" <?php if($Id!="" and $incentiveStatus==0){ echo "selected='selected'";}?>  >Active</option> 
	      </select>
