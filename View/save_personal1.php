...
if (isset($_REQUEST['empid']) && $EmployeeID == '' && !isset($_POST['txt_Personal_First'])) {
	...
	echo $sql = 'call get_personal("' . $EmployeeID . '")';
	$result = $myDB->rawQuery($sql);
	$mysql_error = $myDB->getLastError();
	if (empty($mysql_error)) {
		if (isset($result[0]['FirstName']) && $result[0]['FirstName'] != "") {
			if (isset($_REQUEST['intid']) && $_REQUEST['intid'] != "") {
		...
		foreach ($result as $key => $value) {
			...
			if ($value['img'] != '') {
				...
				} else if ($dir_location == "10") {
					$sourceDirectory = "Gurgaon/";
				} else if ($dir_location == "11") {
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<?php if ($_SESSION["__user_logid"] == ADMINISTRATORID || $_SESSION["__user_logid"] == 'CE061930039') { ?>
