...
<!-- Header for Form If any -->
	 <h4>Upload APR<a class="btn-floating btn-large waves-effect waves-light modal-trigger tooltipped"  href="#myModal_content" data-position="bottom" data-tooltip="Download Formate"><i class="material-icons">file_download</i></a></h4>				
							...
							{							 	
								 	...
								 	{	
								 			$date_month = date_parse($row['AG']);
 								 			$sql_p_inert='CALL insert_attendance("'.strtoupper($row['A']).'","'.$row['B'].'","'.$row['C'].'","'.$row['D'].'","'.$row['E'].'","'.$row['F'].'","'.$row['G'].'","'.$row['H'].'","'.$row['I'].'","'.$row['J'].'","'.$row['K'].'","'.$row['L'].'","'.$row['M'].'","'.$row['N'].'","'.$row['O'].'","'.$row['P'].'","'.$row['Q'].'","'.$row['R'].'","'.$row['S'].'","'.$row['T'].'","'.$row['U'].'","'.$row['V'].'","'.$row['W'].'","'.$row['X'].'","'.$row['Y'].'","'.$row['Z'].'","'.$row['AA'].'","'.$row['AB'].'","'.$row['AC'].'","'.$row['AD'].'","'.$row['AE'].'","'.$row['AF'].'","'.intval($date_month['month']).'","'.intval($row['AH']).'","'.$_POST['txt_Type_Upload'].'", "'.$_SESSION['__user_logid'].'");';
