...
<span id="PageTittle_span" class="hidden">Quality Daily Remark Report</span>
...
<!-- Header for Form If any -->
	 <h4>Quality Daily Remark Report</h4>				
...
<!--Reprot / Data Table start -->			
		...
		{
			$sqlConnect='call getReport_QRDaily("'.$date_From.'","'.$date_To.'")';
			$myDB=new MysqliDb();
