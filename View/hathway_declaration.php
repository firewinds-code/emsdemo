...
$locationid = $EmpName = $add = $fathername = $desig = $mobile = '';
...
$sqlquery = "select t1.EmployeeID,t1.EmployeeName,address_p,FatherName, case when df_id in (74,77) then 'Agent' else 'Support Staff' end as desig,mobile from personal_details t1 join employee_map t2 on t1.EmployeeID=t2.EmployeeID join address_details t5 on t2.EmployeeID=t5.EmployeeID join contact_details t3 on t1.EmployeeID=t3.EmployeeID where t2.EmployeeID= ?";
...
$createdon = date("j", strtotime(date('Y-m-d H:i:s', time()))) . "<sup>" . date("S", strtotime(date('Y-m-d H:i:s', time()))) . " </sup>" . date(" M", strtotime(date('Y-m-d H:i:s', time()))) . ' ' . date("Y H:i", strtotime(date('Y-m-d H:i:s', time())));


if (isset($_POST['btnSave'])) {
	$source = 'Web';
	$query = "insert into hathway_decl (EmployeeID, EmpName,Address,fathername,designation,mobile,source) values(?,?,?,?,?,?,?) ";
	$stmt = $conn->prepare($query);
	$stmt->bind_param("sssssss", $EmployeeID, $EmployeeName, $add, $fathername, $desig, $mobile, $source);
...
<div id="content" class="content">
	...
	<span id="PageTittle_span" class="hidden">Hathway Declaration</span>
	...
	<div class="pim-container row" id="div_main">
		...
		<div class="form-div">
			...
			<div class="schema-form-section row">
				...
				<p style="padding-top: 25px;"> This is to confirm that I <b><?php echo $EmployeeName; ?></b> resident of <b><?php echo $add  ?></b> S/O, D/O <b><?php echo  $fathername  ?></b> am working as <b><?php echo $desig  ?></b> for Hathway Digital Limited. </p>
				...
				<p> &nbsp; &nbsp;&nbsp;&nbsp; b) Will ensure no information pertaining to the process is shared to anyone who is not a part of Hathway Digital Limited process </p>
				...
				<p><br /> <b><span>Employee Name: <?php echo $EmployeeName; ?></b></span> <br /><b><span>Employee ID: <?php echo $EmployeeID; ?></b></span> <br /><b><span>Mobile : <?php echo $mobile; ?></b></span> <br /><b><span>Date and Time of Action : <?php echo $createdon; ?></b></span> </p>
