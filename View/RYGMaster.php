...
{
	  $insert="insert into ryg_substatus_master (`RYG`,`remark`,`CreatedBy`)values ('".$_POST['txt_ryg']."' , '".$_POST['txt_issuename']."', '".$_SESSION['__user_logid']."');"; 
	  $myDB= new MysqliDb();
...
{
	  $update="update  ryg_substatus_master set RYG ='".$_POST['txt_ryg']."' ,remark='".$_POST['txt_issuename']."',updatedBy='".$_SESSION['__user_logid']."',updatedOn=now()  where id='".$_POST['UpdateId']."';";
	  $myDB= new MysqliDb();
