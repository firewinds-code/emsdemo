        ...
        <div class="form-div">
            ...
            <div class="schema-form-section row">
                ...
                if (isset($_POST['view'])) {
                    ...
                    $sqlConnect = " select b.id, b.EmployeeID,b.check_flag,b.Modifiedon,c.client_name,w.Process,w.sub_process, w.EmployeeName,w.designation,l1.location,w.DOJ, case when b.bgv_flag ='1' then 'Completed' else 'Not Completed' end as bgvstatus,b.bgv_uploaded from whole_details_peremp as w join client_master as c on w.client_name=c.client_id join bgv as b on w.EmployeeID=b.EmployeeID join location_master l1 on l1.id=w.location where b.flag=1 and cast(b.Modifiedon as date) between '" . $date_From . "' and '" . $date_To . "'";
                    $myDB = new MysqliDb();
