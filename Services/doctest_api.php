...
$select_emp = "select EmployeeID from bgv where EmployeeID='CE12102224'";
$myDB =  new MysqliDb();
            ...
            if (count($query) > 0) {
                ...
                if (count($SQL) > 0) {
                    ...
                    if ($sla_id != '') {
                        ...
                        $data['first_name'] = 'Masood test curl q';
                        ...
                        //$data['jaf_file_attachments[ ]'] = 'https://ems.cogentlab.com/erpm/Services/Docs_Inactivezip/CE12102224.zip';

                        $data['jaf_file_attachments[ ]'] = new CURLFILE('https://ems.cogentlab.com/erpm/Services/Docs_Inactivezip/CE12102224.zip', 'application/zip', 'CE12102224.zip');
