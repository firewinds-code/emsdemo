...
class sendsms
{
  ...
  private $token;
	...
	function sendmessage($credit,$sender,$message,$number,$teplateid)
	{
		$message = urlencode($message);
		 $smsurl = $this->url.'sendsms/'.$this->token.$this->sender.$sender.$this->number.$number.$this->credit.$credit.$this->message.$message.$this->templateid.$teplateid;
		//return $smsurl;
		//die;
