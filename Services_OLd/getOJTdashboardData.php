...
store_execution_time('Start');
 ...
 $query="select Alias as Batch_Alias,traing as StartCount, ActiveCount, t.cm_id, t.BatchID, t.BacthName, t.client, t.clientid,locationName,location, StartDate,EndDate,TrainerName,TrainerID,present,ifnull(ncns,0)ncns,process, sub_process,process_id
from 
