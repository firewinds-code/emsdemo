...
$sql = "insert into EmpID_Name (EmpID, EmpName, loc) select  t1.EmployeeID, t1.EmployeeName,t1.location from personal_details t1 join employee_map t2 on t1.EmployeeID=t2.EmployeeID where cast(t2.createdon as date)=cast(date_add(now(), interval -1 day) as date);";
