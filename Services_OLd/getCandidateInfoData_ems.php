...
$SelectQuery = "select location from personal_details where EmployeeID=? ";
$selectQury = $conn->prepare($SelectQuery);
$selectQury->bind_param("s", $iid);
$selectQury->execute();
$result2 = $selectQury->get_result();
